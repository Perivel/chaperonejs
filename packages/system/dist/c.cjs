...
void 0===M&&(M=setTimeout(B,0))}}process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH&&!D.__patched&&(j=z(D),D.__patched=!0),function(t){
...
r.preserveTimestamps&&"ia32"===process.arch&&console.warn("fs-extra: Using the preserveTimestamps option in 32-bit node is not recommended;\n\n    see https://github.com/jprichardson/node-fs-extra/issues/269");const{srcStat:n,destStat:i}=vt.checkPathsSync(t,e,"copy");return vt.checkParentPathsSync(t,n,e,"copy"),function(t,e,r,n){if(n.filter&&!n.filter(e,r))return;const i=mt.dirname(r);yt.existsSync(i)||wt(i);return Et(t,e,r,n)}(i,t,e,r)}};const _t=y.fromPromise,Ft=p;var Ot={pathExists:_t((function(t){return Ft.access(t).then((()=>!0)).catch((()=>!1))})),pathExistsSync:Ft.existsSync};const Dt=j,Nt=o,Pt=tt.mkdirs,Tt=Ot.pathExists,Ct=rt,Lt=pt;function It(t,e,r,n,i){const s=Nt.dirname(r);Tt(s,((o,c)=>o?i(o):c?Mt(t,e,r,n,i):void Pt(s,(s=>s?i(s):Mt(t,e,r,n,i)))))}function Rt(t,e,r,n,i,s){Promise.resolve(i.filter(r,n)).then((o=>o?t(e,r,n,i,s):s()),(t=>s(t)))}function Mt(t,e,r,n,i){return n.filter?Rt(jt,t,e,r,n,i):jt(t,e,r,n,i)}function jt(t,e,r,n,i){(n.dereference?Dt.stat:Dt.lstat)(e,((s,o)=>s?i(s):o.isDirectory()?function(t,e,r,n,i,s){if(!e)return function(t,e,r,n,i){Dt.mkdir(r,(s=>{if(s)return i(s);Bt(e,r,n,(e=>e?i(e):At(r,t,i)))}))}(t.mode,r,n,i,s);if(e&&!e.isDirectory())return s(new Error(`Cannot overwrite non-directory '${n}' with directory '${r}'.`));return Bt(r,n,i,s)}(o,t,e,r,n,i):o.isFile()||o.isCharacterDevice()||o.isBlockDevice()?function(t,e,r,n,i,s){return e?function(t,e,r,n,i){if(!n.overwrite)return n.errorOnExist?i(new Error(`'${r}' already exists`)):i();Dt.unlink(r,(s=>s?i(s):zt(t,e,r,n,i)))}(t,r,n,i,s):zt(t,r,n,i,s)}(o,t,e,r,n,i):o.isSymbolicLink()?function(t,e,r,n,i){Dt.readlink(e,((e,s)=>e?i(e):(n.dereference&&(s=Nt.resolve(process.cwd(),s)),t?void Dt.readlink(r,((e,o)=>e?
// dest exists and is a regular file or directory,
// Windows may throw UNKNOWN error. If dest already exists,
// fs throws error anyway, so no need to guard against it here.
...
// dest in this case would result in removing src contents
// and therefore a broken symlink would be created.
t.isDirectory()&&Lt.isSrcSubdir(o,s)?i(new Error(`Cannot overwrite '${o}' with '${s}'.`)):function(t,e,r){Dt.unlink(e,(n=>n?r(n):Dt.symlink(t,e,r)))}(s,r,i)))):Dt.symlink(s,r,i))))}(t,e,r,n,i):void 0))}function zt(t,e,r,n,i){Dt.copyFile(e,r,(s=>s?i(s):n.preserveTimestamps?function(t,e,r,n){
// Make sure the file is writable before setting the timestamp
// otherwise open fails with EPERM when invoked with 'r+'
// (through utimes call)
 ...
 */
class Ir{constructor(){this._size=0}get size(){return this._size}
/**
       * clear()
       *
 ...
 *
 * A Generic Node.
 */class Mr{constructor(t,e=null,r=null){this.value=t,this._next=e,this.compare=r||((t,e)=>(t.length,e.length,t>e?1:t<e?-1:0))}get hasNext(){return null!==this.next}get next(){return this._next}set next(t){this._next=t}compareTo(t){let e;switch(this.compare(this.value,t)){case-1:e=c.ComparisonResult.Less;break;case 1:e=c.ComparisonResult.Greater;break;default:e=c.ComparisonResult.Same}return e}}
/**
 * StackException
 *
 * A stack error.
 ...
 *
 * A stack.
 */class zr extends Ir{constructor(t=null){super(),this.top=null,this.compareFn=t
/**
     * add()
     *
 ...
 *
 * A Queue.
 */class Ar extends Ir{constructor(t=null){super(),this.head=null,this.tail=null,this.compareFn=t
/**
     * add()
     *
...
/**
     ...
     */static FromSegments(...t){const e=new zr;return Jr._BuildPath(t,e),new Jr(e.toArray().reverse().join(Jr.Separator))}
/**
     * basename()
     *
...
/*
        ...
        */
let e=t.toString().split(/(\/|\\)/gm);const r=new Ar;return e.forEach((t=>{".."===t?
// backstep
r.add(Pr.BackStep):""==t?
// current directory.
