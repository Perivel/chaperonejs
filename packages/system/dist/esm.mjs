...
// This function uses the graceful-fs shared queue
t.apply(U,arguments),st()}return Object.defineProperty(e,G,{value:t}),e}(U.closeSync),/\bgfs4\b/i.test(process.env.NODE_DEBUG||"")&&process.on("exit",(function(){Z(U[Y]),v.equal(U[Y].length,0)}))}N[Y]||Q(N,U[Y]);var et,rt=nt(K(U));function nt(t){
...
// file
createFile:ze.createFile,createFileSync:ze.createFileSync,ensureFile:ze.createFile,ensureFileSync:ze.createFileSync,
// link
...
// jsonfile exports
readJson:mr.readFile,readJsonSync:mr.readFileSync,writeJson:mr.writeFile,writeJsonSync:mr.writeFileSync};const wr=L.fromCallback,Sr=rt,vr=E,gr=vt,Er=Gt.pathExists;var br={outputFile:wr((function(t,e,r,n){"function"==typeof r&&(n=r,r="utf8");const i=vr.dirname(t);Er(i,((s,o)=>s?n(s):o?Sr.writeFile(t,e,r,n):void gr.mkdirs(i,(i=>{if(i)return n(i);Sr.writeFile(t,e,r,n)}))))})),outputFileSync:function(t,...e){const r=vr.dirname(t);if(Sr.existsSync(r))return Sr.writeFileSync(t,...e);gr.mkdirsSync(r),Sr.writeFileSync(t,...e)}};const{stringify:kr}=ar,{outputFile:_r}=br;var Fr=async function(t,e,r={}){const n=kr(e,r);await _r(t,n,r)};const{stringify:Or}=ar,{outputFileSync:xr}=br;var Pr=function(t,e,r){const n=Or(e,r);xr(t,n,r)};const Dr=L.fromPromise,Nr=pr;Nr.outputJson=Dr(Fr),Nr.outputJsonSync=Pr,
// aliases
Nr.outputJSON=Nr.outputJson,Nr.outputJSONSync=Nr.outputJsonSync,Nr.writeJSON=Nr.writeJson,Nr.writeJSONSync=Nr.writeJsonSync,Nr.readJSON=Nr.readJson,Nr.readJSONSync=Nr.readJsonSync;var Tr=Nr;const Cr=rt,Ir=E,Lr=Wt.copySync,Rr=_e.removeSync,Mr=vt.mkdirpSync,zr=It;function jr(t,e,r){try{Cr.renameSync(t,e)}catch(n){if("EXDEV"!==n.code)throw n;return function(t,e,r){const n={overwrite:r,errorOnExist:!0};return Lr(t,e,n),Rr(t)}(t,e,r)}}var qr={moveSync:function(t,e,r){const n=(r=r||{}).overwrite||r.clobber||!1,{srcStat:i}=zr.checkPathsSync(t,e,"move");return zr.checkParentPathsSync(t,i,e,"move"),Mr(Ir.dirname(e)),function(t,e,r){if(r)return Rr(e),jr(t,e,r);if(Cr.existsSync(e))throw new Error("dest already exists.");return jr(t,e,r)}(t,e,n)}};const Ar=rt,Br=E,Jr=ue.copy,Wr=_e.remove,$r=vt.mkdirp,Yr=Gt.pathExists,Gr=It;function Ur(t,e,r,n){Ar.rename(t,e,(i=>i?"EXDEV"!==i.code?n(i):function(t,e,r,n){const i={overwrite:r,errorOnExist:!0};Jr(t,e,i,(e=>e?n(e):Wr(t,n)))}(t,e,r,n):n()))}var Vr=function(t,e,r,n){"function"==typeof r&&(n=r,r={});const i=r.overwrite||r.clobber||!1;Gr.checkPaths(t,e,"move",((r,s)=>{if(r)return n(r);const{srcStat:o}=s;Gr.checkParentPaths(t,o,e,"move",(r=>{if(r)return n(r);$r(Br.dirname(e),(r=>r?n(r):function(t,e,r,n){if(r)return Wr(e,(i=>i?n(i):Ur(t,e,r,n)));Yr(e,((i,s)=>i?n(i):s?n(new Error("dest already exists.")):Ur(t,e,r,n)))}(t,e,i,n)))}))}))};var Xr,Kr,Hr,Qr={move:(0,L.fromCallback)(Vr)};!function(t){t.exports={
// Export promiseified graceful-fs:
...I,
// Export extra methods:
...Wt,...ue,...Ce,...cr,...Tr,...vt,...qr,...Qr,...br,...Gt,..._e};
 ...
 *
 * A Generic Node.
 */class en{value;_next;compare;constructor(t,e=null,r=null){this.value=t,this._next=e,this.compare=r||((t,e)=>(t.length,e.length,t>e?1:t<e?-1:0))}get hasNext(){return null!==this.next}get next(){return this._next}set next(t){this._next=t}compareTo(t){let e;switch(this.compare(this.value,t)){case-1:e=b.Less;break;case 1:e=b.Greater;break;default:e=b.Same}return e}}
/**
 * StackException
 *
 * A stack error.
...
/**
     ...
     */static async Create(t,e){throw new _}
/**
     * Exists()
     *
...
/**
    ...
    */static async GetStats(t){try{const r=await e(t.toString(),{bigint:!1});return{dev:r.dev,ino:r.ino,mode:r.mode,nlink:r.nlink,uid:r.uid,gid:r.gid,rdev:r.rdev,size:r.size,blksize:r.blksize,blocks:r.blocks,atimeMs:r.atimeMs,mtimeMs:r.mtimeMs,ctimeMs:r.ctimeMs,birthtimeMs:r.birthtimeMs,atime:F.FromDate(r.atime,O.UTC()),mtime:F.FromDate(r.mtime,O.UTC()),ctime:F.FromDate(r.ctime,O.UTC()),birthtime:F.FromDate(r.birthtime,O.UTC()),isBlockDevice:r.isBlockDevice(),isCharacterDevice:r.isCharacterDevice(),isDirectory:r.isDirectory(),isFIFO:r.isFIFO(),isFile:r.isFile(),isSocket:r.isSocket(),isSymbolicLink:r.isSymbolicLink()}}catch(t){throw new ln(t.message)}}get createdOn(){var t;return null===(t=this.stats)||void 0===t?void 0:t.birthtime}get deletedOn(){return this._deleted}get isDeleted(){return null!=this.deletedOn}get isDirectory(){return this.stats.isDirectory}get isFile(){return this.stats.isFile}get isLink(){return this.stats.isSymbolicLink}get path(){return this._path}get updatedOn(){return this.stats.mtime}
/**
     * delete()
     *
     * deletes the directory.
     * @param options delete options.
     */async delete(t){this._deleted=F.Now()}equals(t){let e=!1;if(t instanceof hn){const r=t;e=this.path.equals(r.path)&&this.createdOn.equals(r.createdOn)&&this.updatedOn.equals(r.updatedOn)}return e}serialize(){return JSON.stringify({})}}
/**
 * FileException
 *
...
/**
     ...
     * @param path The path of the resource to create.
     * @returns the created FileSystem Entry.
     */static async Create(t,e){if(await pn.Exists(t))throw new mn;
// create the file.
const n=t instanceof un?t:new un(t.toString());try{await r(n.toString(),"")}catch(t){throw new dn(t.message)}return pn.ForPath(n)}
/**
     * Exist()
     *
     ...
     */static async Exists(t){try{const e=await super.Exists(t),r=await pn.GetStats(t);return e&&r.isFile}catch(t){throw new dn(t.message)}}
/**
     * ForPath()
     *
...
if(await hn.Exists(r))throw new mn;
...
// delete the file.
try{await i(this.path.toString(),{force:e.force,recursive:e.recursive}),super.delete()}catch(t){throw new dn(t.message)}}equals(t){return t instanceof pn&&super.equals(t)}
/**
     * move()
     *
...
const i=await hn.Exists(r);if(i)throw new mn;if(i&&!n.override)throw new mn;
// move the file.
try{return await s(this.path.toString(),r.toString()),await pn.ForPath(r)}catch(t){throw new dn(t.message)}}
/**
     * rename()
     *
...
// rename the file.
try{return await s(this.path.toString(),e.toString()),await pn.ForPath(e)}catch(t){throw new dn(t.message)}}serialize(){return JSON.stringify({path:this.path.toString(),created_on:this.createdOn.toString(),updated_on:this.updatedOn.toString()})}}
// file enums
!function(t){
/**
...
if(await gn.Exists(t))throw new vn;
// create the Link.
const i=t instanceof un?t:new un(t.toString()),s=e instanceof un?e:new un(e);let c;c=r?{type:r.type?r.type:Hr.File}:{type:Hr.File};try{await o(s.toString(),i.toString(),null===(n=c.type)||void 0===n?void 0:n.toString())}catch(t){throw new wn(t.message)}return await gn.ForPath(i)}
/**
     * Exist()
     *
     ...
     */static async Exists(t){try{const e=await super.Exists(t),r=await gn.GetStats(t);return e&&r.isSymbolicLink}catch(t){throw new wn(t.message)}}
/**
     * ForPath()
     *
     ...
     */static async ForPath(t){try{if(!await gn.Exists(t))throw new Sn;
// get the stats
const e=await gn.GetStats(t);
// return the reference
return new gn(t,e)}catch(t){throw t instanceof ln?new wn(t.message):t}}
/**
     * delete()
     *
     * deletes the directory.
     ...
     */async delete(t){
// delete the link.
try{await c(this.path.toString()),super.delete()}catch(t){throw new wn(t.message)}}equals(t){return t instanceof gn&&super.equals(t)}
/**
     * isValid()
     *
...
/**
     ...
     * @param path The path of the resource to create.
     * @returns the created FileSystem Entry.
     */static async Create(t,e){if(await _n.Exists(t))throw new kn;
// create the directory.
const r=t instanceof un?t:new un(t.toString());try{await u(r.toString(),{recursive:!0,mode:"0o777"})}catch(t){throw new En(t.message)}return _n.ForPath(r)}
/**
     * ForPath()
     *
     * Creates a reference to a directory specified by the path.
     ...
     * @throws DirectoryNotFoundException when the directory is not found.
     * @throws DirectoryException when the operation fails.
     */static async ForPath(t){try{if(!await _n.Exists(t))throw new bn;
// get the stats
const e=await _n.GetStats(t);
// return the reference
return new _n(t,e)}catch(t){throw t instanceof ln?new En(t.message):t}}
/**
     * Current()
     *
     * Gets the current working directory.
     * @returns The current working directory.
     */static async Current(){return await _n.ForPath(process.cwd())}
/**
     * Exist()
     *
     ...
     * @returns TRUE if the directory exists. FALSE otherwise.
     * @throws DirectoryException if an error occurs performing the operation.
     */static async Exists(t){try{const e=await super.Exists(t),r=await _n.GetStats(t);return e&&r.isDirectory}catch(t){throw new En(t.message)}}
/**
     * contents()
     *
     * gets the contents of the directory.
     * @thorws DirectoryException when the operation fails.
     */async contents(){try{const t=await l(this.path.toString());return await this.convertToObjects(t)}catch(t){throw new En(t.message)}}
/**
     * convertToObjects()
     *
     ...
     */async convertToObjects(t){const e=new Array;let r;return await Promise.all(t.map((async t=>{const n=await hn.ForPath(t);r=n.stats.isDirectory?await _n.ForPath(n.path):n.isFile?await pn.ForPath(n.path):await gn.ForPath(n.path),e.push(r)}))),e}
/**
     * copy()
     *
     * copies the directory to the specified path.
...
// delete the file.
try{await f(this.path.toString(),{recursive:e.recursive,maxRetries:e.maxRetries,retryDelay:e.retryDelay}),await super.delete()}catch(t){throw new En(t.message)}}equals(t){return t instanceof _n&&super.equals(t)}
/**
     * move()
     *
     * moves the filesystem entry to the specified path.
...
// move the file.
try{return await T.move(this.path.toString(),r.toString(),{overwrite:n.overwrite}),await _n.ForPath(r)}catch(t){throw new En(t.message)}}
/**
     * rename()
     *
     * renames the filesystem entry.
...
const e=un.FromSegments(this.path.dirname(),t);
// rename the file.
try{return await s(this.path.toString(),e.toString()),_n.ForPath(e)}catch(t){throw new En(t.message)}}serialize(){return JSON.stringify({path:this.path.toString(),created_on:this.createdOn.toString(),updated_on:this.updatedOn.toString()})}}class Fn extends cn{constructor(t="File Stream Error"){super(t)}}
/**
 * FileStreamDataException
 *
 * File Stream Data error
 */class On extends Fn{constructor(t="Stream Data Error"){super(t)}}class xn{constructor(t){this._file=t}
/**
     * file()
     *
     * the source file of the stream.
     */file(){return this._file}equals(t){let e=!1;if(t instanceof xn){const r=t;e=this.file().equals(r.file())}return e}toString(){return`Stream for file ${this.file().path.toString()}`}}
/**
 * FileReader
 *
 * A FileReader class
...
/**
     ...
     */all(){if(this._isClosed)throw new Fn;let t,e="";for(;t=this._stream.read();)e+=t.toString(this.encoding());return e}
/**
     * close()
     *
...
/**
     ...
     *
     * the stream encoding.
     */encoding(){return this._encoding}equals(t){let e=!1;if(t instanceof Pn){const r=t;e=super.equals(r)&&this.encoding()===r.encoding()}return e}
/**
     * hasNext()
     *
...
/**
     ...
     * @return the data.
     */async next(t=64){if(this._isClosed)throw new Fn;if(!this._fileSize){const t=this.file().stats;this._fileSize=t.size}t=t>Pn.MAX_BYTES?Pn.MAX_BYTES:t;const e=this._stream.read(t);if(e)return this._bytesRead+=t,e.toString(this.encoding());
// no data to read.
throw new On}}
...
/**
     ...
     */async write(t){if(this._isClosed)throw new Fn;
// write the data
...
/**
     ...
     */sendMessage(t){return new Promise(((e,r)=>{this.canBeMessaged()?this.childProcess.send(t,(t=>{t?r(new Nn(t.message)):e()})):r(new Nn("Message cannot be sent"))}))}toString(){return this.id().toString()}}export{Kr as CopyFileMode,_n as Directory,kn as DirectoryAlreadyExistsException,En as DirectoryException,bn as DirectoryNotFoundException,pn as File,mn as FileAlreadyExistsException,dn as FileException,yn as FileNotFoundException,Pn as FileReader,xn as FileStream,On as FileStreamDataException,Fn as FileStreamException,hn as FileSystemEntry,ln as FileSystemEntryException,fn as FileSystemEntryNotFoundException,Dn as FileWriter,gn as Link,vn as LinkAlreadyExistsException,wn as LinkException,Sn as LinkNotFoundException,Hr as LinkType,un as Path,an as PathException,Cn as Process,Nn as ProcessException,Tn as ProcessFailedException,cn as SystemException};
