 ...
 */class s extends e.BaseException{constructor(e="Container Error"){super(e)}}
/**
 ...
 */class d extends s{constructor(e="Module not found"){super(e)}}class c{
/**
     * hasSubmodule()
     *
 ...
 */class u extends c{constructor(){super()}
/**
     * canParse()
     *
 ...
 */class h{instances;bindings;modules;moduleParser;
// This is used to track circular dependencies
instanciationMap;constructor(e=new u){this.instances=new Map,this.bindings=new Map,this.modules=new Map,this.instanciationMap=new Set,this.moduleParser=e}
/**
     * bind()
     *
...
/**
     ...
     */containsModule(e){const s=this.parser().root(e);return this.parser().hasSubmodules(e)?this.module(s).containsModule(this.parser().submodules(e)):this.modules.has(s)}
/**
     * createModule()
     *
     * creates a module.
     ...
     * @throws InvalidModuleException when the module path cannot be parsed.
     */createModule(e){const s=this.parser().root(e);if(this.containsModule(s)){if(!this.parser().hasSubmodules(e))throw new o(`Module '${e}' already in use.`)}else this.modules.set(s,new h(this.moduleParser));
...
/**
     ...
     */
getDependencyIdFromToken(e){return e.name}}exports.CircularDependencyException=t,exports.Container=h,exports.ContainerException=s,exports.DefaultModuleParser=u,exports.DependencyNotFoundException=n,exports.DuplicateBindingException=i,exports.DuplicateDependencyException=r,exports.DuplicateModuleException=o,exports.InvalidModuleException=a,exports.ModuleNotFoundException=d,exports.ModuleParser=c;
