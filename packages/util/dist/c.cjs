 ...
 */class q extends g{constructor(a="Timezone error."){super(a)}}
/**
 * Timezone
 *
 ...
 */class P extends g{constructor(a="Date error."){super(a)}}
/**
 * DurationException
 *
 * DurationException represents a generic duration error.
 */class L extends g{constructor(a="Duration error."){super(a)}}
/**
 * DateTime
 *
 ...
 */
class R extends b{constructor(a="Invalid ID"){super(a)}}
/**
 * UUIDException
 *
 ...
 *
 * Money error.
 */class na extends g{constructor(a="Money Error"){super(a)}}
/**
 * Money
 *
...
/**
     ...
     */
castToString(a){return null==a?"":"string"===typeof a?a:a.toString()}},exports.Timezone=D,exports.TimezoneException=q,exports.UUID=V,exports.UUIDException=H;
