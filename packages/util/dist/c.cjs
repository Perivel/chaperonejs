"use strict";var a=require("colors-convert"),l=require("bcryptjs"),n=require("luxon"),h=require("i18n-iso-countries"),e=require("change-case"),t=require("uuid"),i=require("awesome-phonenumber"),s=require("sanitize-html");function r(a){var l=Object.create(null);return a&&Object.keys(a).forEach((function(n){if("default"!==n){var h=Object.getOwnPropertyDescriptor(a,n);Object.defineProperty(l,n,h.get?h:{enumerable:!0,get:function(){return a[n]}})}})),l.default=a,Object.freeze(l)}var u=r(l),p=r(h);
/**
 * CharacterSet
 *
 * A CharacterSet.
...
/**
     ...
     */equals(a){let l=!1;if(a instanceof o){const n=a;l=this.value===n.value}return l}toString(){return this.value}}
/**
 * BaseException
 *
 ...
 */class g extends c{constructor(a="Invalid Argument"){super(a)}}
/**
 ...
 */
exports.ComparisonResult=void 0,(b=exports.ComparisonResult||(exports.ComparisonResult={}))[b.Less=0]="Less",b[b.Same=1]="Same",b[b.Greater=2]="Greater";
/**
 * ColorException
 *
 * A generic color error.
 */
class m extends c{constructor(a="Color Error"){super(a)}}
/**
 * HexException
 *
 * A Hex value error.
...
/**
     ...
     */static async Generate(a=10){return new f(await u.genSalt(a))}
/**
     * equals()
     *
...
return new Promise(((n,h)=>{u.hash(a.toString(),l.value,((a,l)=>{a?h(a):n(new w(l))}))}))}
/**
      * value
      *
...
/**
     ...
     * @param suspect the suspect to compare
     */equals(a){let l=!1;return a instanceof w&&(l=this.value===a.value),l}toString(){return this.value}}class v extends c{constructor(a="Country Error"){super(a)}}class x extends g{constructor(a="Street Address Error"){super(a)}}class S extends x{constructor(a="Invalid Locality"){super(a)}}class _ extends x{constructor(a="Invalid Postal Code"){super(a)}}class C extends x{constructor(a="Invalid Region"){super(a)}}class z extends x{constructor(a="Invalid Street"){super(a)}}
/**
 * TimezoneException
 *
 * TimezoneException represents a generic timezone error.
 */class q extends c{constructor(a="Timezone error."){super(a)}}
/**
 * Timezone
 *
...
throw new q;
// timezone exists.
const l=n.IANAZone.create(a),h=n.DateTime.fromJSDate(new Date).setZone(l);return new D(l.name,h.toFormat("ZZZZ"),h.offset)}
/**
     * Local()
     *
     ...
     */static Local(){const a=n.DateTime.local();return new D(a.zone.name,a.toFormat("ZZZZ"),a.offset)}
/**
     * UTC()
     *
     * UTC() sets the timezone to UTC.
     */static UTC(){const a=n.DateTime.fromJSDate(new Date).setZone("utc");return new D(a.zone.name,a.toFormat("ZZZZ"),a.offset)}
/**
     * abbreviation
     *
...
/**
     ...
     */equals(a){let l=!1;if(a instanceof D){const n=a;l=this.id===n.id&&this.abbreviation===n.abbreviation&&this.utcOffset===n.utcOffset}return l}
/**
     * id
     *
...
/**
     ...
     */
constructor(a){const l=a.toUpperCase(),n=p.getName(l,"en");if(!n)
// invalid country
...
/**
     ...
     * @param suspect The suspect to be compared.
     */equals(a){let l=!1;if(a instanceof I){const n=a;l=this.code===n.code}return l}toString(){return this.name}}
/**
 * Street
 *
...
/**
     ...
     */static FromPrimitives(a,l="",n,h,e,t){const i=new M(a,l),s=new T(n),r=new N(h),u=new j(e),p=new I(t);return new B(i,s,r,u,p)}
/**
     * country
     *
 ...
 */class P extends c{constructor(a="Date error."){super(a)}}
/**
 * DurationException
 *
 * DurationException represents a generic duration error.
 */class L extends c{constructor(a="Duration error."){super(a)}}
/**
 * DateTime
 *
...
/**
     ...
     * @param value Date
     */
constructor(a,l,h,e=0,t=0,i=0,s=0,r=D.UTC()){if(this.date=n.DateTime.fromObject({year:a,month:l,day:h,hour:e,minute:t,second:i,millisecond:s},{zone:"utc"}),!this.date.isValid)throw new P;this.tz=r}
/**
     * FromDate()
     *
...
/**
     ...
     */static Local(){return O.FromDate(n.DateTime.local().toJSDate(),D.Local())}
/**
     * Now()
     *
     * Creates a DateTime for the current UTC date and time.
     */static Now(a=D.UTC()){return O.FromDate(n.DateTime.utc().toJSDate(),a)}
/**
     * add()
     *
...
/**
     ...
     */toUtc(){return O.FromDate(this.value,D.UTC())}
/**
     * toTimeaone()
     *
...
// not valid.
throw new L(this.luxonDuration.invalidReason)}
/**
...
// Overrides
// ==========================
toString(){return this.luxonDuration.toISO()}}class G extends g{constructor(a="Invalid Email Address"){super(a)}}
/**
 * EmailAddress
 *
 ...
 */
class R extends g{constructor(a="Invalid ID"){super(a)}}
/**
 * UUIDException
 *
 * Indicates an error with the UUID.
 */class H extends R{constructor(a="UUID Error"){super(a)}}
/**
 * Id
 *
...
/**
     ...
     */
constructor(a){if(!a)throw new R;this._val=a}
/**
     * equals()
     *
...
/**
     ...
     * @param suspect the suspect to compare.
     */equals(a){let l=!1;if(a instanceof Y){const n=a;l=this.name===n.name&&this.alpha2===n.alpha2&&this.alpha3b===n.alpha3b&&this.alpha3t===n.alpha3t}return l}
/**
     * name
     *
 ...
 */class Q extends g{constructor(a="Phone Number Error"){super(a)}}
/**
 * PhoneNumber
 *
 ...
 *
 * Money error.
 */class na extends c{constructor(a="Money Error"){super(a)}}
/**
 * Money
 *
...
/**
     ...
     */add(a){if(this.currency.symbol!==a.currency.symbol)throw new na(`Cannot add money with different currencies (${this.currency.symbol} and ${a.currency.symbol})`);const l=this._toDecimal(this.amountInCents+a.amountInCents,this.currency.decimalPlaces);return new ha(l,this.currency)}
/**
     * divide()
     *
     * divides the money value by the factor.
     * @param divisor the divisor
     */divide(a){if(0!==a){const l=this._toDecimal(this.amountInCents/a,this.currency.decimalPlaces);return new ha(l,this.currency)}throw new na("Cannot divide by zero.")}equals(a){let l=!1;if(a instanceof ha){const n=a;l=this.currency.equals(n.currency)&&this.amountInCents===n.amountInCents}return l}
/**
     * multiply()
     *
     * multiplies the money value by the factor.
     * @param factor the factor
     */multiply(a){const l=this._toDecimal(this.amountInCents*a,this.currency.decimalPlaces);return new ha(l,this.currency)}serialize(){return JSON.stringify({amount:this.amount,amount_in_cents:this.amountInCents,currency:this.currency.serialize()})}
/**
     * subtract()
     *
     ...
     */subtract(a){if(this.currency.symbol!==a.currency.symbol)throw new na(`Cannot subtract money with different currencies (${this.currency.symbol} and ${a.currency.symbol})`);const l=this._toDecimal(this.amountInCents-a.amountInCents,this.currency.decimalPlaces);return new ha(l,this.currency)}
/**
     * _toDecimal()
     *
 ...
 */
class extends c{constructor(a="Network Error"){super(a)}}
/**
 * Comparator
 *
...
/**
     ...
     */
castToString(a){return null==a?"":"string"===typeof a?a:a.toString()}},exports.Timezone=D,exports.TimezoneException=q,exports.UUID=V,exports.UUIDException=H,exports.compare=(a,l)=>{const n=a,h=l;if(n===h)return 0;{
