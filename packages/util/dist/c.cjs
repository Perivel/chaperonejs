"use strict";var a=require("colors-convert"),l=require("bcryptjs"),n=require("luxon"),h=require("i18n-iso-countries"),e=require("change-case"),t=require("uuid"),i=require("awesome-phonenumber"),s=require("sanitize-html");function r(a){var l=Object.create(null);return a&&Object.keys(a).forEach((function(n){if("default"!==n){var h=Object.getOwnPropertyDescriptor(a,n);Object.defineProperty(l,n,h.get?h:{enumerable:!0,get:function(){return a[n]}})}})),l.default=a,Object.freeze(l)}var u,p=r(l),o=r(h);
/**
 * CharacterSet
 *
 * A CharacterSet.
 ...
 */class g extends Error{constructor(a="A domain error occured."){super(a)}}
/**
 * InvlaidArguentException
 *
 * InvalidArgumentException indicates an argument is invalid.
 */class b extends g{constructor(a="Invalid Argument"){super(a)}}
/**
 ...
 */
exports.ComparisonResult=void 0,(u=exports.ComparisonResult||(exports.ComparisonResult={}))[u.Less=0]="Less",u[u.Same=1]="Same",u[u.Greater=2]="Greater";
/**
 * ColorException
 *
 * A generic color error.
 */
class m extends g{constructor(a="Color Error"){super(a)}}
/**
 * HexException
 *
 * A Hex value error.
 */class E extends m{constructor(a="Hex Error"){super(a)}}
/**
 * Hex
 *
 * A Hex color value.
...
/**
     ...
     */static Black(a=1){return y.FromRGBA(0,0,0,a)}
/**
     * Blue()
     *
     ...
     */static Blue(a=1){return y.FromRGBA(0,0,255,a)}
/**
     * FromHex()
     *
...
/**
     ...
     */static FromRGBA(a,l,n,h=1){const e=new k(a,l,n,h);return new y(e)}
/**
     * Green()
     *
     ...
     */static Green(a=1){return y.FromRGBA(0,255,0,a)}
/**
     * Red()
     *
     ...
     */static Red(a=1){return y.FromRGBA(255,0,0,a)}
/**
     * White()
     *
     ...
     */static White(a=1){return y.FromRGBA(255,255,255,a)}equals(a){let l=!1;if(a instanceof y){const n=a;l=this.rgba.equals(n.rgba)&&this.hex.equals(n.hex)}return l}
/**
     * hex()
     *
...
/**
     ...
     */static async Generate(a=10){return new f(await p.genSalt(a))}
/**
     * equals()
     *
     ...
     */equals(a){let l=!1;return a instanceof f&&(l=a.value===this.value),l}
/**
     * value
     *
...
return new Promise(((n,h)=>{p.hash(a.toString(),l.value,((a,l)=>{a?h(a):n(new w(l))}))}))}
/**
      * value
      *
...
/**
     ...
     * @param suspect the suspect to compare
     */equals(a){let l=!1;return a instanceof w&&(l=this.value===a.value),l}toString(){return this.value}}class v extends g{constructor(a="Country Error"){super(a)}}class x extends b{constructor(a="Street Address Error"){super(a)}}class S extends x{constructor(a="Invalid Locality"){super(a)}}class C extends x{constructor(a="Invalid Postal Code"){super(a)}}class z extends x{constructor(a="Invalid Region"){super(a)}}class q extends x{constructor(a="Invalid Street"){super(a)}}
/**
 * TimezoneException
 *
 * TimezoneException represents a generic timezone error.
 */class _ extends g{constructor(a="Timezone error."){super(a)}}
/**
 * Timezone
 *
...
/**
     ...
     */static FromId(a){if(!n.IANAZone.isValidZone(a))
// invalid timezone.
throw new _;
// timezone exists.
 ...
 */class D{constructor(a,l){this._long=a,this._lat=l}
/**
     * equals()
     *
     * equals() compares the suspect to the instance, to determine if they are equals.
     * @param suspect The suspect to compare.
     */equals(a){let l=!1;if(a instanceof D){const n=a;l=this.longitude===n.longitude&&this.latitude===n.latitude}return l}
/**
     * latitude()
     *
     * gets the latitude.
...
/**
     ...
     */
constructor(a){const l=a.toUpperCase(),n=o.getName(l,"en");if(!n)
// invalid country
throw new v;this._code=l,this._name=n}
/**
     * code
     *
...
/**
     ...
     * @param suspect The suspect to be compared.
     */equals(a){let l=!1;if(a instanceof M){const n=a;l=this.code===n.code}return l}toString(){return this.name}}
/**
 * Street
 *
...
/**
     ...
     */
constructor(a,l=""){if(!a){throw new q}this._line1=a,this._line2=l}
/**
     * Determines if two streets are equal.
     * @param suspect The value being compared.
     */equals(a){let l=!1;if(a instanceof I){const n=a;l=this.line1===n.line1&&this.line2==this.line2}return l}
/**
     * line1
     *
...
/**
     * Compares the instance to the suspect to determine if they are equal.
     * @param suspect The suspect to compare.
     */equals(a){let l=!1;if(a instanceof T){const n=a;l=this.name===n.name}return l}
/**
     * name
     *
...
/**
     ...
     * @param suspect the suspect to be compared.
     */equals(a){let l=!1;if(a instanceof N){const n=a;l=this.name===n.name}return l}
/**
     * name()
     *
...
/**
     ...
     * @param suspect The value being compared.
     */equals(a){let l=!1;if(a instanceof j){const n=a;l=this.value===n.value}return l}serialize(){return this.value}toString(){return this.serialize()}
/**
     * value
     *
...
/**
     ...
     *
     */
constructor(a,l,n,h,e){let t=null;if(!a)throw t=new q,t;if(!l)throw t=new S,t;if(!n)throw t=new z,t;if(!h)throw t=new C,t;if(!e)throw t=new v,t;this._street=a,this._locality=l,this._region=n,this._postal=h,this._country=e}
/**
     * FromPrimitives()
     *
     ...
     */static FromPrimitives(a,l="",n,h,e,t){const i=new I(a,l),s=new T(n),r=new N(h),u=new j(e),p=new M(t);return new B(i,s,r,u,p)}
/**
     * country
     *
 ...
 */class L extends g{constructor(a="Date error."){super(a)}}
/**
 * DurationException
 *
 * DurationException represents a generic duration error.
 */class P extends g{constructor(a="Duration error."){super(a)}}
/**
 * DateTime
 *
...
/**
     ...
     * @param value Date
     */
constructor(a,l,h,e=0,t=0,i=0,s=0,r=A.UTC()){if(this.date=n.DateTime.fromObject({year:a,month:l,day:h,hour:e,minute:t,second:i,millisecond:s},{zone:"utc"}),!this.date.isValid)throw new L;this.tz=r}
/**
     * FromDate()
     *
     ...
     */static FromDate(a,l){const h=n.DateTime.fromJSDate(a).toUTC();return new O(h.year,h.month,h.day,h.hour,h.minute,h.second,h.millisecond,l)}
/**
     * FromIsoString()
     *
     ...
     */static FromIsoString(a,l){const h=n.DateTime.fromISO(a);return new O(h.year,h.month,h.day,h.hour,h.minute,h.second,h.millisecond,l)}
/**
     * Local()
     *
     ...
     */static Local(){return O.FromDate(n.DateTime.local().toJSDate(),A.Local())}
/**
     * Now()
     *
     * Creates a DateTime for the current UTC date and time.
     */static Now(a=A.UTC()){return O.FromDate(n.DateTime.utc().toJSDate(),a)}
/**
     * add()
     *
     * add() adds the duration to the datetime.
     * @param duration the duration to add.
     */add(a){return O.FromDate(this.date.plus(n.Duration.fromObject({years:a.years,quarters:a.quarters,months:a.months,weeks:a.weeks,days:a.days,hours:a.hours,minutes:a.minutes,seconds:a.seconds,milliseconds:a.miliseconds})).toJSDate(),this.timezone)}
/**
     * day
     *
...
/**
     ...
     * @param suspect The suspect to be compared.
     */isAfter(a){let l=!1;if(a instanceof O){const n=a;l=this.date>n.date}return l}
/**
     * isBefore()
     *
     ...
     */isBefore(a){let l=!1;if(a instanceof O){const n=a;l=this.date<n.date}return l}
/**
     * equals()
     *
     ...
     */equals(a){let l=!1;if(a instanceof O){const n=a;l=this.date.equals(n.date)}return l}
/**
     * milisecond
     *
...
/**
     ...
     */subtract(a){return O.FromDate(this.date.minus(n.Duration.fromObject({years:a.years,quarters:a.quarters,months:a.months,weeks:a.weeks,days:a.days,hours:a.hours,minutes:a.minutes,seconds:a.seconds,milliseconds:a.miliseconds})).toJSDate(),this.timezone)}
/**
     * timezone()
     *
...
/**
     ...
     */toUtc(){return O.FromDate(this.value,A.UTC())}
/**
     * toTimeaone()
     *
     * toTimezone() converts the timestamp to the specified timezone.
     * @param timezone The timezone to convert to.
     */toTimezone(a){return O.FromDate(this.value,a)}
/**
     * isoString()
     *
...
/**
     ...
     */
constructor({years:a=0,quarters:l=0,months:h=0,weeks:e=0,days:t=0,hours:i=0,minutes:s=0,seconds:r=0,miliseconds:u=0}){if(this.luxonDuration=n.Duration.fromObject({years:a,quarters:l,months:h,weeks:e,days:t,hours:i,minutes:s,seconds:r,milliseconds:u},{conversionAccuracy:"longterm"}),!this.luxonDuration.isValid)
// not valid.
throw new P(this.luxonDuration.invalidReason)}
/**
     ...
     */static FromDateTimeDifference(a,l){const h=n.DateTime.fromISO(a.toString()),e=n.DateTime.fromISO(l.toString()),t=a.isAfter(l)?h.diff(e):e.diff(h);return new K({years:t.years,quarters:t.quarters,months:t.months,weeks:t.weeks,days:t.days,hours:t.hours,minutes:t.minutes,seconds:t.seconds,miliseconds:t.milliseconds})}
/**
     * days
     *
...
/**
     ...
     * @param suspect the suspect to compare.
     */equals(a){let l=!1;if(a instanceof K){const n=a;l=this.luxonDuration.equals(n.luxonDuration)}return l}
/**
     * hours
     *
...
// Overrides
// ==========================
toString(){return this.luxonDuration.toISO()}}class G extends b{constructor(a="Invalid Email Address"){super(a)}}
/**
 * EmailAddress
 *
...
// email is invalid.
throw new G;{this._value=a;const l=a.indexOf("@");this._username=a.substring(0,l),this._domain=a.substring(l+1)}}
/**
     * domainName
     *
...
/**
     ...
     * equals() compares the instance to the suspect, to determine if they are equal.
     * @param suspect The suspect to be compared.
     */equals(a){let l=!1;if(a instanceof Z){const n=a;l=this.value===n.value}return l}
/**
     * username
     *
 ...
 */
class U extends b{constructor(a="Invalid ID"){super(a)}}
/**
 * UUIDException
 *
 * Indicates an error with the UUID.
 */class H extends U{constructor(a="UUID Error"){super(a)}}
/**
 * Id
 *
...
/**
     ...
     */
constructor(a){if(!a)throw new U;this._val=a}
/**
     * equals()
     *
     * equals() compares the suspect to the intance, to determine if they are equal.
     * @param suspect The suspect to compare.
     */equals(a){let l=!1;if(a instanceof J){const n=a;l=this.value===n.value}return l}
/**
     * value
     *
...
/**
     ...
     */
constructor(a){if(!t.validate(a))throw new H;super(a)}
/**
     * _ParseNamespace()
     *
     ...
     */static _ParseNamespace(a){let l="";if(a instanceof V)l=a.value;else
// we validate that the string is a valid UUID.
try{l=new V(a.toString()).toString()}catch(a){
// the namespace is not a valid UUID.
throw new H("Invalid namespace.")}return l}
/**
     * NIL()
     *
     * Creates the NIL UUID.
     * @returns a nil UUID (all zeros)
     */static NIL(){return new V(t.NIL)}
/**
     * V1()
     *
     * Generates a Version 1 UUID (Timestamp).
     * @returns A version 1 UUID.
     */static V1(){return new V(t.v1())}
/**
     * V3()
     *
     ...
     * @throws UUIDException when the namespace is not a valid UUID.
     */static V3(a,l){return new V(t.v3(a,V._ParseNamespace(l)))}
/**
     * V4()
     *
     * V4() generates a V4 UUID (random)
     * @returns a Version 4 UUID.
     */static V4(){return new V(t.v4())}
/**
     * V5()
     *
     ...
     * @throws UUIDException when the namespace is not a valid UUID.
     */static V5(a,l){return new V(t.v5(a,V._ParseNamespace(l)))}
/**
     * equals()
     *
     * equals() compares the suspect to the instance, to determine if they are equal.
     * @param suspect The suspect to be compared.
     */equals(a){let l=!1;if(a instanceof V){const n=a;l=this.value===n.value}return l}
/**
     * value
     *
     * gets the value of the id.
...
/**
     ...
     */
constructor(a){const l=a.toLocaleLowerCase().trim(),n=Y.find((a=>{var n,h;return a.English.toLocaleLowerCase()===l||(null===(n=a.alpha2)||void 0===n?void 0:n.toLocaleLowerCase())===l||a["alpha3-b"].toLowerCase()===l||(null===(h=a["alpha3-t"])||void 0===h?void 0:h.toLocaleLowerCase())===l}));if(!n)
// no data found.
throw new W;
// data is found.
...
/**
     ...
     * @param suspect the suspect to compare.
     */equals(a){let l=!1;if(a instanceof $){const n=a;l=this.name===n.name&&this.alpha2===n.alpha2&&this.alpha3b===n.alpha3b&&this.alpha3t===n.alpha3t}return l}
/**
     * name
     *
 ...
 */class Q extends b{constructor(a="Phone Number Error"){super(a)}}
/**
 * PhoneNumber
 *
...
if(this._phoneParser=i.parsePhoneNumber(a,{regionCode:l}),!this._phoneParser.valid)throw new Q}
/**
...
/**
     ...
     */equals(a){let l=!1;if(a instanceof X){const n=a;l=this.value===n.value}return l}
/**
     * e164
     *
...
/**
     ...
     */get value(){return this.international}toString(){return this.value}}class aa{constructor(){
...
/**
     ...
     */sanitize(a){return s(a)}toString(){return`Instance of ${aa.name}`}}
/**
 * MoneyException
 *
 * Money error.
 */class la extends g{constructor(a="Money Error"){super(a)}}
/**
 * Money
 *
 * A class representing monetary values.
 */class na{constructor(a,l){this._amountInCents=Math.round(a*Math.pow(10,l.decimalPlaces)),this._currency=l}get amount(){return this.amountInCents/Math.pow(10,this.currency.decimalPlaces)}get amountInCents(){return this._amountInCents}get currency(){return this._currency}
/**
     * add()
     *
     ...
     */add(a){if(this.currency.symbol!==a.currency.symbol)throw new la(`Cannot add money with different currencies (${this.currency.symbol} and ${a.currency.symbol})`);return new na(this.amountInCents+a.amountInCents,this.currency)}
/**
     * divide()
     *
     * divides the money value by the factor.
     * @param divisor the divisor
     */divide(a){return new na(this.amountInCents/a,this.currency)}equals(a){let l=!1;if(a instanceof na){const n=a;l=this.currency.equals(n.currency)&&this.amountInCents===n.amountInCents}return l}
/**
     * multiply()
     *
     * multiplies the money value by the factor.
     * @param factor the factor
     */multiply(a){return new na(this.amountInCents*a,this.currency)}
/**
     * subtract()
     *
     ...
     */subtract(a){if(this.currency.symbol!==a.currency.symbol)throw new la(`Cannot subtract money with different currencies (${this.currency.symbol} and ${a.currency.symbol})`);return new na(this.amountInCents-a.amountInCents,this.currency)}}
/**
 * Currency
 *
 * A representation of currency.
 */class ha{constructor(a,l,n=2){this.symbol=a,this.name=l,this.decimalPlaces=n}
/**
     * USD()
     */static USD(){return new ha("USD","United States Dollar",2)}equals(a){let l=!1;if(a instanceof ha){const n=a;l=this.decimalPlaces===n.decimalPlaces&&this.symbol===n.symbol&&this.name===n.name}return l}serialize(){return JSON.stringify({symbol:this.symbol,name:this.name,decimal_places:this.decimalPlaces})}toString(){return this.name}}exports.BaseException=g,exports.BaseFormatter=R,exports.CharacterSet=c,exports.Color=y,exports.ColorException=m,exports.Coordinates=D,exports.Country=M,exports.CountryException=v,exports.Currency=ha,exports.DateException=L,exports.DateTime=O,exports.Duration=K,exports.DurationException=P,exports.EmailAddress=Z,exports.EmailAddressException=G,exports.HTMLSanitizer=aa,exports.Hash=w,exports.Hex=F,exports.HexException=E,exports.Id=J,exports.IdException=U,exports.InvalidArgumentException=b,exports.IsoLanguage=$,exports.IsoLanguageException=W,exports.Locality=T,exports.LocalityException=S,exports.MethodUndefinedException=class extends g{constructor(a="Method undefined."){super(a)}},exports.Money=na,exports.MoneyException=la,exports.NetworkException=
/**
 * NetworkException
 *
...
/**
     ...
     */static Integer(a,l){return a=Math.floor(a),l=Math.floor(l),Math.floor(Math.random()*(l-a)+a)}},exports.Region=N,exports.RegionException=z,exports.Salt=f,exports.Street=I,exports.StreetAddress=B,exports.StreetAddressException=x,exports.StreetException=q,exports.StringFormatter=class extends R{constructor(){super()}
/**
     * camelCase()
     *
     ...
     */camelCase(a){return e.camelCase(this.castToString(a),{})}
/**
     * capitalCase()
     *
     ...
     */capitalCase(a){return e.capitalCase(this.castToString(a))}
/**
     * constantCase()
     *
     ...
     */constantCase(a){return e.constantCase(this.castToString(a))}
/**
     * dotCase()
     *
     ...
     */dotCase(a){return e.dotCase(this.castToString(a))}
/**
     * headerCase()
     *
     ...
     */headerCase(a){return e.headerCase(this.castToString(a))}
/**
     * noCase()
     *
     ...
     */noCase(a){return e.noCase(this.castToString(a))}
/**
     * paramCase()
     *
     ...
     */paramCase(a){return e.paramCase(this.castToString(a))}
/**
     * pascalCase()
     *
     ...
     */pascalCase(a){return e.pascalCase(this.castToString(a))}
/**
     * pathCase()
     *
     ...
     */pathCase(a){return e.pathCase(this.castToString(a))}
/**
     * snakeCase()
     *
     ...
     */snakeCase(a){return e.snakeCase(this.castToString(a))}
// =============================
// Helpers
// =============================
/**
     ...
     */
castToString(a){return null==a?"":"string"===typeof a?a:a.toString()}},exports.Timezone=A,exports.TimezoneException=_,exports.UUID=V,exports.UUIDException=H;
