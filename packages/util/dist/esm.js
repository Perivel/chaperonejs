...
/**
     ...
     */equals(a){let l=!1;if(a instanceof C){const n=a;l=this.value()===n.value()}return l}
/**
     * value()
     *
 ...
 */class _ extends Error{constructor(a="A domain error occured."){super(a)}}
/**
 * InvlaidArguentException
 *
 * InvalidArgumentException indicates an argument is invalid.
 */class x extends _{constructor(a="Invalid Argument"){super(a)}}
/**
 * MethodUndefinedException
 *
 * MethodUndefinedException is an error indicating that a method
 * that was called is undefined.
 */class A extends _{constructor(a="Method undefined."){super(a)}}class D extends x{constructor(a="Argument out of bounds."){super(a)}}
/**
 * NetworkException
 *
 * NetworkException indicates a network exception has occured.
 */class j extends _{constructor(a="Network Error"){super(a)}}
/**
 * ColorException
 *
 * A generic color error.
 */class T extends _{constructor(a="Color Error"){super(a)}}
/**
 * HexException
 *
 * A Hex value error.
 ...
 *
 * An RGBA value error.
 */class N extends T{constructor(a="RGBA Error"){super(a)}}
/**
 * RGBA
 *
...
/**
     ...
     */
constructor(a){if(a instanceof I)this._rgba=a,this._hex=new B(l({r:this._rgba.r(),g:this._rgba.g(),b:this._rgba.b(),a:this._rgba.a()}));else{this._hex=a;const l=n(this._hex.value());this._rgba=new I(l.r,l.g,l.b,l.a)}}
/**
     * Black()
     *
...
/**
     ...
     * @throws HexException when the Hex value is invalid.
     */static FromHex(a){const l=new B(a);return new L(l)}
/**
     * FromRGBA()
     *
...
/**
     ...
     * @param suspect the suspect to compare
     */equals(a){let l=!1;return a instanceof O&&(l=this.value()===a.value()),l}toString(){return this.value()}
/**
     * value()
     *
     * gets the value of the hash.
     */value(){return this._value}}class P extends _{constructor(a="Country Error"){super(a)}}class G extends x{constructor(a="Street Address Error"){super(a)}}class Z extends G{constructor(a="Invalid Locality"){super(a)}}class U extends G{constructor(a="Invalid Postal Code"){super(a)}}class R extends G{constructor(a="Invalid Region"){super(a)}}class H extends G{constructor(a="Invalid Street"){super(a)}}
/**
 * TimezoneException
 *
 * TimezoneException represents a generic timezone error.
 */class J extends _{constructor(a="Timezone error."){super(a)}}
/**
 * Timezone
 *
...
// invalid country
throw new P;this._code=l,this._name=n}
/**
     * code()
     *
...
/**
     ...
     *
     */
constructor(a,l,n,h,e){let i=null;if(!a)throw i=new H,i;if(!l)throw i=new Z,i;if(!n)throw i=new R,i;if(!h)throw i=new U,i;if(!e)throw i=new P,i;this._street=a,this._locality=l,this._region=n,this._postal=h,this._country=e}
/**
     * FromPrimitives()
     *
 ...
 */class na extends _{constructor(a="Date error."){super(a)}}
/**
 * DurationException
 *
 * DurationException represents a generic duration error.
 */class ha extends _{constructor(a="Duration error."){super(a)}}
/**
 * DateTime
 *
...
/**
     ...
     */static V3(a,l){return new ga(f(a,l))}
/**
     * V4()
     *
...
/**
     ...
     */static V5(a,l){return new ga(v(a,l))}
/**
     * equals()
     *
...
/**
     ...
     */sanitize(a){return q(a)}toString(){return`Instance of ${ka.name}`}}export{_ as BaseException,ra as BaseFormatter,C as CharacterSet,L as Color,T as ColorException,W as Coordinates,Y as Country,P as CountryException,na as DateException,ea as DateTime,ia as Duration,ha as DurationException,ta as EmailAddress,sa as EmailAddressException,ka as HTMLSanitizer,O as Hash,B as Hex,M as HexException,ca as Id,pa as IdException,x as InvalidArgumentException,Ea as IsoLanguage,ba as IsoLanguageException,Q as Locality,Z as LocalityException,A as MethodUndefinedException,j as NetworkException,D as OutOfBoundsException,da as PhoneNumber,ma as PhoneNumberException,aa as PostalCode,U as PostalCodeException,I as RGBA,N as RGBAException,X as Region,R as RegionException,K as Salt,$ as Street,la as StreetAddress,G as StreetAddressException,H as StreetException,ua as StringFormatter,V as Timezone,J as TimezoneException,ga as UUID,oa as UUIDException};
