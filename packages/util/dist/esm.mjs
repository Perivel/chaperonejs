import{isHex as a,rgbaToHex as l,hexToRgba as n}from"colors-convert";import*as h from"bcryptjs";import{IANAZone as e,DateTime as i,Duration as t}from"luxon";import*as s from"i18n-iso-countries";import{camelCase as r,capitalCase as u,constantCase as p,dotCase as o,headerCase as g,noCase as c,paramCase as b,pascalCase as F,pathCase as E,snakeCase as m}from"change-case";import{validate as d,NIL as k,v1 as f,v3 as w,v4 as y,v5 as v,version as S}from"uuid";import{parsePhoneNumber as z}from"awesome-phonenumber";import _ from"sanitize-html";
/**
 * CharacterSet
 *
 * A CharacterSet.
...
/**
     ...
     */equals(a){let l=!1;if(a instanceof q){const n=a;l=this.value===n.value}return l}toString(){return this.value}}
/**
 * BaseException
 *
 ...
 */class A extends C{constructor(a="Method undefined."){super(a)}}class M extends x{constructor(a="Argument out of bounds."){super(a)}}
/**
 * NetworkException
 *
 * NetworkException indicates a network exception has occured.
 */class D extends C{constructor(a="Network Error"){super(a)}}
/**
 * ComparisonResult
 *
 ...
 */class T extends C{constructor(a="Color Error"){super(a)}}
/**
 * HexException
 *
 * A Hex value error.
...
/**
     ...
     */
constructor(l){if(l=l.toUpperCase(),!a(l))throw new B;this._value=l}equals(a){let l=!1;if(a instanceof I){const n=a;l=this.value===n.value}return l}serialize(){return this.value}toString(){return this.serialize()}
/**
     * value()
     *
     * gets the value.
...
/**
     ...
     */
constructor(a){if(a instanceof K)this._rgba=a,this._hex=new I(l({r:this._rgba.r,g:this._rgba.g,b:this._rgba.b,a:this._rgba.a}));else{this._hex=a;const l=n(this._hex.value);this._rgba=new K(l.r,l.g,l.b,l.a)}}
/**
     * Black()
     *
     ...
     */static Black(a=1){return P.FromRGBA(0,0,0,a)}
/**
     * Blue()
     *
     ...
     */static Blue(a=1){return P.FromRGBA(0,0,255,a)}
/**
     * FromHex()
     *
     ...
     * @throws HexException when the Hex value is invalid.
     */static FromHex(a){const l=new I(a);return new P(l)}
/**
     * FromRGBA()
     *
     ...
     */static FromRGBA(a,l,n,h=1){const e=new K(a,l,n,h);return new P(e)}
/**
     * Green()
     *
     ...
     */static Green(a=1){return P.FromRGBA(0,255,0,a)}
/**
     * Red()
     *
     ...
     */static Red(a=1){return P.FromRGBA(255,0,0,a)}
/**
     * White()
     *
     ...
     */static White(a=1){return P.FromRGBA(255,255,255,a)}equals(a){let l=!1;if(a instanceof P){const n=a;l=this.rgba.equals(n.rgba)&&this.hex.equals(n.hex)}return l}
/**
     * hex()
     *
...
/**
     ...
     */static async Generate(a=10){return new O(await h.genSalt(a))}
/**
     * equals()
     *
     ...
     */equals(a){let l=!1;return a instanceof O&&(l=a.value===this.value),l}
/**
     * value
     *
...
return new Promise(((n,e)=>{h.hash(a.toString(),l.value,((a,l)=>{a?e(a):n(new G(l))}))}))}
/**
      * value
      *
...
/**
     ...
     * @param suspect the suspect to compare
     */equals(a){let l=!1;return a instanceof G&&(l=this.value===a.value),l}toString(){return this.value}}class Z extends C{constructor(a="Country Error"){super(a)}}class U extends x{constructor(a="Street Address Error"){super(a)}}class R extends U{constructor(a="Invalid Locality"){super(a)}}class H extends U{constructor(a="Invalid Postal Code"){super(a)}}class J extends U{constructor(a="Invalid Region"){super(a)}}class V extends U{constructor(a="Invalid Street"){super(a)}}
/**
 * TimezoneException
 *
 * TimezoneException represents a generic timezone error.
 */class W extends C{constructor(a="Timezone error."){super(a)}}
/**
 * Timezone
 *
...
throw new W;
// timezone exists.
const l=e.create(a),n=i.fromJSDate(new Date).setZone(l);return new Y(l.name,n.toFormat("ZZZZ"),n.offset)}
/**
     * Local()
     *
     ...
     */static Local(){const a=i.local();return new Y(a.zone.name,a.toFormat("ZZZZ"),a.offset)}
/**
     * UTC()
     *
     * UTC() sets the timezone to UTC.
     */static UTC(){const a=i.fromJSDate(new Date).setZone("utc");return new Y(a.zone.name,a.toFormat("ZZZZ"),a.offset)}
/**
     * abbreviation
     *
...
// invalid country
throw new Z;this._code=l,this._name=n}
/**
     * code
     *
...
/**
     ...
     * @param suspect The suspect to be compared.
     */equals(a){let l=!1;if(a instanceof Q){const n=a;l=this.code===n.code}return l}toString(){return this.name}}
/**
 * Street
 *
...
/**
     ...
     */
constructor(a,l=""){if(!a){throw new V}this._line1=a,this._line2=l}
/**
     * Determines if two streets are equal.
     * @param suspect The value being compared.
     */equals(a){let l=!1;if(a instanceof X){const n=a;l=this.line1===n.line1&&this.line2==this.line2}return l}
/**
     * line1
     *
...
/**
     * Compares the instance to the suspect to determine if they are equal.
     * @param suspect The suspect to compare.
     */equals(a){let l=!1;if(a instanceof aa){const n=a;l=this.name===n.name}return l}
/**
     * name
     *
...
/**
     ...
     */
constructor(a){if(!a){throw new J}this._name=a}
/**
     * equals()
     *
...
/**
     ...
     */
constructor(a){if(!a){throw new H}this._value=a}
/**
     * equals()
     *
     * equals() compares the PostalCode object to the suspect to determine if they are equal.
     * @param suspect The value being compared.
     */equals(a){let l=!1;if(a instanceof na){const n=a;l=this.value===n.value}return l}serialize(){return this.value}toString(){return this.serialize()}
/**
     * value
     *
...
/**
     ...
     *
     */
constructor(a,l,n,h,e){let i=null;if(!a)throw i=new V,i;if(!l)throw i=new R,i;if(!n)throw i=new J,i;if(!h)throw i=new H,i;if(!e)throw i=new Z,i;this._street=a,this._locality=l,this._region=n,this._postal=h,this._country=e}
/**
     * FromPrimitives()
     *
     ...
     */static FromPrimitives(a,l="",n,h,e,i){const t=new X(a,l),s=new aa(n),r=new la(h),u=new na(e),p=new Q(i);return new ha(t,s,r,u,p)}
/**
     * country
     *
...
/**
     ...
     */equals(a){let l=!1;if(a instanceof ha){const n=a;l=this.street.equals(n.street)&&this.locality.equals(n.locality)&&this.region.equals(n.region)&&this.postalCode.equals(n.postalCode)&&this.country.equals(n.country)}return l}
/**
     * locality
     *
 ...
 */class ea extends C{constructor(a="Date error."){super(a)}}
/**
 * DurationException
 *
 * DurationException represents a generic duration error.
 */class ia extends C{constructor(a="Duration error."){super(a)}}
/**
 * DateTime
 *
...
/**
     ...
     * @param value Date
     */
constructor(a,l,n,h=0,e=0,t=0,s=0,r=Y.UTC()){if(this.date=i.fromObject({year:a,month:l,day:n,hour:h,minute:e,second:t,millisecond:s},{zone:"utc"}),!this.date.isValid)throw new ea;this.tz=r}
/**
     * FromDate()
     *
     ...
     */static FromDate(a,l){const n=i.fromJSDate(a).toUTC();return new ta(n.year,n.month,n.day,n.hour,n.minute,n.second,n.millisecond,l)}
/**
     * FromIsoString()
     *
     ...
     */static FromIsoString(a,l){const n=i.fromISO(a);return new ta(n.year,n.month,n.day,n.hour,n.minute,n.second,n.millisecond,l)}
/**
     * Local()
     *
     ...
     */static Local(){return ta.FromDate(i.local().toJSDate(),Y.Local())}
/**
     * Now()
     *
     * Creates a DateTime for the current UTC date and time.
     */static Now(a=Y.UTC()){return ta.FromDate(i.utc().toJSDate(),a)}
/**
     * add()
     *
     * add() adds the duration to the datetime.
     * @param duration the duration to add.
     */add(a){return ta.FromDate(this.date.plus(t.fromObject({years:a.years,quarters:a.quarters,months:a.months,weeks:a.weeks,days:a.days,hours:a.hours,minutes:a.minutes,seconds:a.seconds,milliseconds:a.miliseconds})).toJSDate(),this.timezone)}
/**
     * day
     *
...
/**
     ...
     * @param suspect The suspect to be compared.
     */isAfter(a){let l=!1;if(a instanceof ta){const n=a;l=this.date>n.date}return l}
/**
     * isBefore()
     *
     ...
     */isBefore(a){let l=!1;if(a instanceof ta){const n=a;l=this.date<n.date}return l}
/**
     * equals()
     *
     ...
     */equals(a){let l=!1;if(a instanceof ta){const n=a;l=this.date.equals(n.date)}return l}
/**
     * milisecond
     *
...
/**
     ...
     */subtract(a){return ta.FromDate(this.date.minus(t.fromObject({years:a.years,quarters:a.quarters,months:a.months,weeks:a.weeks,days:a.days,hours:a.hours,minutes:a.minutes,seconds:a.seconds,milliseconds:a.miliseconds})).toJSDate(),this.timezone)}
/**
     * timezone()
     *
...
/**
     ...
     */toUtc(){return ta.FromDate(this.value,Y.UTC())}
/**
     * toTimeaone()
     *
     * toTimezone() converts the timestamp to the specified timezone.
     * @param timezone The timezone to convert to.
     */toTimezone(a){return ta.FromDate(this.value,a)}
/**
     * isoString()
     *
...
/**
     ...
     */
constructor({years:a=0,quarters:l=0,months:n=0,weeks:h=0,days:e=0,hours:i=0,minutes:s=0,seconds:r=0,miliseconds:u=0}){if(this.luxonDuration=t.fromObject({years:a,quarters:l,months:n,weeks:h,days:e,hours:i,minutes:s,seconds:r,milliseconds:u},{conversionAccuracy:"longterm"}),!this.luxonDuration.isValid)
// not valid.
...
/**
     ...
     */static FromDateTimeDifference(a,l){const n=i.fromISO(a.toString()),h=i.fromISO(l.toString()),e=a.isAfter(l)?n.diff(h):h.diff(n);return new sa({years:e.years,quarters:e.quarters,months:e.months,weeks:e.weeks,days:e.days,hours:e.hours,minutes:e.minutes,seconds:e.seconds,miliseconds:e.milliseconds})}
/**
     * days
     *
...
/**
     ...
     * @param suspect the suspect to compare.
     */equals(a){let l=!1;if(a instanceof sa){const n=a;l=this.luxonDuration.equals(n.luxonDuration)}return l}
/**
     * hours
     *
...
// Overrides
// ==========================
toString(){return this.luxonDuration.toISO()}}class ra extends x{constructor(a="Invalid Email Address"){super(a)}}
/**
 * EmailAddress
 *
...
// email is invalid.
throw new ra;{this._value=a;const l=a.indexOf("@");this._username=a.substring(0,l),this._domain=a.substring(l+1)}}
/**
     * domainName
     *
...
/**
     ...
     * equals() compares the instance to the suspect, to determine if they are equal.
     * @param suspect The suspect to be compared.
     */equals(a){let l=!1;if(a instanceof ua){const n=a;l=this.value===n.value}return l}
/**
     * username
     *
 ...
 */class oa extends pa{constructor(){super()}
/**
     * camelCase()
     *
...
/**
     ...
     */headerCase(a){return g(this.castToString(a))}
/**
     * noCase()
     *
     ...
     */noCase(a){return c(this.castToString(a))}
/**
     * paramCase()
     *
 ...
 */class ca extends ga{constructor(a="UUID Error"){super(a)}}
/**
 * Id
 *
...
/**
     ...
     * @param suspect The suspect to compare.
     */equals(a){let l=!1;if(a instanceof ba){const n=a;l=this.value===n.value}return l}
/**
     * value
     *
...
/**
     ...
     */
constructor(a){if(!d(a))throw new ca;super(a)}
/**
     * _ParseNamespace()
     *
...
throw new ca("Invalid namespace.")}return l}
/**
     * NIL()
     *
...
/**
     ...
     * @throws UUIDException when the namespace is not a valid UUID.
     */static V3(a,l){return new Fa(w(a,Fa._ParseNamespace(l)))}
/**
     * V4()
     *
     * V4() generates a V4 UUID (random)
     * @returns a Version 4 UUID.
     */static V4(){return new Fa(y())}
/**
     * V5()
     *
...
/**
     ...
     */
constructor(a){const l=a.toLocaleLowerCase().trim(),n=ma.find((a=>{var n,h;return a.English.toLocaleLowerCase()===l||(null===(n=a.alpha2)||void 0===n?void 0:n.toLocaleLowerCase())===l||a["alpha3-b"].toLowerCase()===l||(null===(h=a["alpha3-t"])||void 0===h?void 0:h.toLocaleLowerCase())===l}));if(!n)
// no data found.
throw new Ea;
// data is found.
...
/**
     ...
     * @param suspect the suspect to compare.
     */equals(a){let l=!1;if(a instanceof da){const n=a;l=this.name===n.name&&this.alpha2===n.alpha2&&this.alpha3b===n.alpha3b&&this.alpha3t===n.alpha3t}return l}
/**
     * name
     *
 ...
 */class ka extends x{constructor(a="Phone Number Error"){super(a)}}
/**
 * PhoneNumber
 *
...
/**
     ...
     */sanitize(a){return _(a)}toString(){return`Instance of ${wa.name}`}}export{C as BaseException,pa as BaseFormatter,q as CharacterSet,P as Color,T as ColorException,j as ComparisonResult,$ as Coordinates,Q as Country,Z as CountryException,ea as DateException,ta as DateTime,sa as Duration,ia as DurationException,ua as EmailAddress,ra as EmailAddressException,wa as HTMLSanitizer,G as Hash,I as Hex,B as HexException,ba as Id,ga as IdException,x as InvalidArgumentException,da as IsoLanguage,Ea as IsoLanguageException,aa as Locality,R as LocalityException,A as MethodUndefinedException,D as NetworkException,M as OutOfBoundsException,fa as PhoneNumber,ka as PhoneNumberException,na as PostalCode,H as PostalCodeException,K as RGBA,L as RGBAException,N as Random,la as Region,J as RegionException,O as Salt,X as Street,ha as StreetAddress,U as StreetAddressException,V as StreetException,oa as StringFormatter,Y as Timezone,W as TimezoneException,Fa as UUID,ca as UUIDException};
