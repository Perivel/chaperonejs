 ...
 */var I;!function(a){a[a.Less=0]="Less",a[a.Same=1]="Same",a[a.Greater=2]="Greater"}(I||(I={}));class j{constructor(){
 ...
 */class N extends q{constructor(a="Color Error"){super(a)}}
/**
 * HexException
 *
 * A Hex value error.
...
/**
     ...
     */
constructor(l){if(l=l.toUpperCase(),!a(l))throw new T;this._value=l}equals(a){let l=!1;if(a instanceof B){const n=a;l=this.value===n.value}return l}serialize(){return this.value}toString(){return this.serialize()}
/**
     * value()
     *
     * gets the value.
...
/**
     ...
     * @param suspect the suspect to compare
     */equals(a){let l=!1;return a instanceof G&&(l=this.value===a.value),l}toString(){return this.value}}class Z extends q{constructor(a="Country Error"){super(a)}}class U extends x{constructor(a="Street Address Error"){super(a)}}class R extends U{constructor(a="Invalid Locality"){super(a)}}class H extends U{constructor(a="Invalid Postal Code"){super(a)}}class J extends U{constructor(a="Invalid Region"){super(a)}}class V extends U{constructor(a="Invalid Street"){super(a)}}
/**
 * TimezoneException
 *
 * TimezoneException represents a generic timezone error.
 */class W extends q{constructor(a="Timezone error."){super(a)}}
/**
 * Timezone
 *
...
/**
     ...
     *
     */
constructor(a,l,n,h,e){let t=null;if(!a)throw t=new V,t;if(!l)throw t=new R,t;if(!n)throw t=new J,t;if(!h)throw t=new H,t;if(!e)throw t=new Z,t;this._street=a,this._locality=l,this._region=n,this._postal=h,this._country=e}
/**
     * FromPrimitives()
     *
     ...
     */static FromPrimitives(a,l="",n,h,e,t){const i=new X(a,l),s=new aa(n),r=new la(h),u=new na(e),p=new Q(t);return new ha(i,s,r,u,p)}
/**
     * country
     *
 ...
 */class ea extends q{constructor(a="Date error."){super(a)}}
/**
 * DurationException
 *
 * DurationException represents a generic duration error.
 */class ta extends q{constructor(a="Duration error."){super(a)}}
/**
 * DateTime
 *
...
/**
     ...
     */static FromDate(a,l){const n=t.fromJSDate(a).toUTC();return new ia(n.year,n.month,n.day,n.hour,n.minute,n.second,n.millisecond,l)}
/**
     * FromIsoString()
     *
     ...
     */static FromIsoString(a,l){const n=t.fromISO(a);return new ia(n.year,n.month,n.day,n.hour,n.minute,n.second,n.millisecond,l)}
/**
     * Local()
     *
...
/**
     ...
     */add(a){return ia.FromDate(this.date.plus(i.fromObject({years:a.years,quarters:a.quarters,months:a.months,weeks:a.weeks,days:a.days,hours:a.hours,minutes:a.minutes,seconds:a.seconds,milliseconds:a.miliseconds})).toJSDate(),this.timezone)}
/**
     * day
     *
...
/**
     ...
     */subtract(a){return ia.FromDate(this.date.minus(i.fromObject({years:a.years,quarters:a.quarters,months:a.months,weeks:a.weeks,days:a.days,hours:a.hours,minutes:a.minutes,seconds:a.seconds,milliseconds:a.miliseconds})).toJSDate(),this.timezone)}
/**
     * timezone()
     *
...
// not valid.
throw new ta(this.luxonDuration.invalidReason)}
/**
     ...
     */static FromDateTimeDifference(a,l){const n=t.fromISO(a.toString()),h=t.fromISO(l.toString()),e=a.isAfter(l)?n.diff(h):h.diff(n);return new sa({years:e.years,quarters:e.quarters,months:e.months,weeks:e.weeks,days:e.days,hours:e.hours,minutes:e.minutes,seconds:e.seconds,miliseconds:e.milliseconds})}
/**
     * days
     *
 ...
 */class ca extends x{constructor(a="Invalid ID"){super(a)}}
/**
 * UUIDException
 *
 * Indicates an error with the UUID.
 */class ga extends ca{constructor(a="UUID Error"){super(a)}}
/**
 * Id
 *
...
/**
     ...
     */
constructor(a){if(!a)throw new ca;this._val=a}
/**
     * equals()
     *
...
/**
     ...
     */static _ParseNamespace(a){let l="";if(a instanceof ma)l=a.value;else
// we validate that the string is a valid UUID.
try{l=new ma(a.toString()).toString()}catch(a){
...
/**
     ...
     * @throws UUIDException when the namespace is not a valid UUID.
     */static V3(a,l){return new ma(f(a,ma._ParseNamespace(l)))}
/**
     * V4()
     *
     * V4() generates a V4 UUID (random)
     * @returns a Version 4 UUID.
     */static V4(){return new ma(w())}
/**
     * V5()
     *
     ...
     * @throws UUIDException when the namespace is not a valid UUID.
     */static V5(a,l){return new ma(v(a,ma._ParseNamespace(l)))}
/**
     * equals()
     *
...
/**
     ...
     */equals(a){let l=!1;if(a instanceof ya){const n=a;l=this.value===n.value}return l}
/**
     * e164
     *
...
/**
     ...
     */get value(){return this.international}toString(){return this.value}}class fa{constructor(){
