 ...
 */class q extends Error{constructor(a="A domain error occured."){super(a)}}
/**
 * InvlaidArguentException
 *
 * InvalidArgumentException indicates an argument is invalid.
 */class x extends q{constructor(a="Invalid Argument"){super(a)}}
/**
 ...
 */const I=(a,l)=>{const n=a,h=l;if(n===h)return 0;{
// they are not the same string.
// so we determine order based on the Unicodeorder of each character.
const a=n.length<h.length?n.length:h.length;let l=0,e=0,t=0,i=0;for(e=0;e<a;e++){if(t=n.charCodeAt(e),i=h.charCodeAt(e),t<i){l=-1;break}if(t>i){l=1;break}}
// we perform one last check if the characters are still equal. That is, we compare the lengths of the string values.
return 0===l&&(n.length<h.length?l=-1:n.length>h.length&&(l=1)),l}};
/**
 * ComparisonResult
 *
 * A result of a comparison operation.
 */var j;!function(a){a[a.Less=0]="Less",a[a.Same=1]="Same",a[a.Greater=2]="Greater"}(j||(j={}));class N{constructor(){
...
/**
     ...
     */static Alpha(a){let l="";const n="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";for(let h=0;h<a;h++)l+=n.charAt(Math.floor(Math.random()*n.length));return l}
/**
     * AlphaNumeric()
     *
     ...
     */static AlphaNumeric(a){let l="";const n="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";for(let h=0;h<a;h++)l+=n.charAt(Math.floor(Math.random()*n.length));return l}
/**
     * Float()
     *
     ...
     */static Float(a,l){return Math.floor(Math.random()*(l-a)+a)}
/**
     * Integer()
     *
     ...
     */static Integer(a,l){return a=Math.floor(a),l=Math.floor(l),Math.floor(Math.random()*(l-a)+a)}}
/**
 * ColorException
 *
 * A generic color error.
 */class T extends q{constructor(a="Color Error"){super(a)}}
/**
 * HexException
 *
 * A Hex value error.
 */class B extends T{constructor(a="Hex Error"){super(a)}}
/**
 * Hex
 *
 * A Hex color value.
...
/**
     ...
     */
constructor(l){if(l=l.toUpperCase(),!a(l))throw new B;this._value=l}equals(a){let l=!1;if(a instanceof P){const n=a;l=this.value===n.value}return l}serialize(){return this.value}toString(){return this.serialize()}
/**
     * value()
     *
     * gets the value.
 ...
 *
 * An RGBA value error.
 */class L extends T{constructor(a="RGBA Error"){super(a)}}
/**
 * RGBA
 *
...
/**
     ...
     *
     * gets the blue value.
     */get b(){return this._b}equals(a){let l=!1;if(a instanceof K){const n=a;l=this.r===n.r&&this.g===n.g&&this.b===n.b&&this.a===n.a}return l}
/**
     * g()
     *
...
/**
     ...
     *
     * gets the red value.
     */get r(){return this._r}serialize(){return JSON.stringify({r:this.r.toString(),g:this.g.toString(),b:this.b.toString(),a:this.a.toString()})}
/**
     * setA()
     *
     ...
     */setA(a){return new K(this.r,this.g,this.b,a)}
/**
     * setB()
     *
     * sets the b value.
     * @param x the value to set.
     * @throws RGBAException when x is invalid.
     */setB(a){return new K(this.r,this.g,a,this.a)}
/**
     * setG()
     *
     * sets the g value.
     * @param x the value to set.
     * @throws RGBAException when x is invalid.
     */setG(a){return new K(this.r,a,this.b,this.a)}
/**
     * setR()
     *
     * sets the r value.
     * @param x the value to set.
     * @throws RGBAException when x is invalid.
     */setR(a){return new K(a,this.g,this.b,this.a)}toString(){return this.serialize()}}
/**
 * Color
 *
 * A Color value.
...
/**
     ...
     */
constructor(a){if(a instanceof K)this._rgba=a,this._hex=new P(l({r:this._rgba.r,g:this._rgba.g,b:this._rgba.b,a:this._rgba.a}));else{this._hex=a;const l=n(this._hex.value);this._rgba=new K(l.r,l.g,l.b,l.a)}}
/**
     * Black()
     *
     ...
     */static Black(a=1){return O.FromRGBA(0,0,0,a)}
/**
     * Blue()
     *
     ...
     */static Blue(a=1){return O.FromRGBA(0,0,255,a)}
/**
     * FromHex()
     *
     ...
     * @throws HexException when the Hex value is invalid.
     */static FromHex(a){const l=new P(a);return new O(l)}
/**
     * FromRGBA()
     *
     ...
     */static FromRGBA(a,l,n,h=1){const e=new K(a,l,n,h);return new O(e)}
/**
     * Green()
     *
     ...
     */static Green(a=1){return O.FromRGBA(0,255,0,a)}
/**
     * Red()
     *
     ...
     */static Red(a=1){return O.FromRGBA(255,0,0,a)}
/**
     * White()
     *
     ...
     */static White(a=1){return O.FromRGBA(255,255,255,a)}equals(a){let l=!1;if(a instanceof O){const n=a;l=this.rgba.equals(n.rgba)&&this.hex.equals(n.hex)}return l}
/**
     * hex()
     *
...
/**
     ...
     */get rgba(){return this._rgba}serialize(){return JSON.stringify({hex:this.hex.serialize(),rgba:this.rgba.serialize()})}toString(){return this.serialize()}}
/**
 * Salt
 *
 * Represents a salt.
...
/**
     ...
     */static async Generate(a=10){return new G(await h.genSalt(a))}
/**
     * equals()
     *
     ...
     */equals(a){let l=!1;return a instanceof G&&(l=a.value===this.value),l}
/**
     * value
     *
     * gets the value of the salt.
     */get value(){return this._value}toString(){return this.value}}
/**
 * Hash
 *
 * A Hash.
 */class Z{_value;constructor(a){this._value=a}
/**
     * Create()
     *
...
return new Promise(((n,e)=>{h.hash(a.toString(),l.value,((a,l)=>{a?e(a):n(new Z(l))}))}))}
/**
      * value
      *
...
/**
     ...
     * @param suspect the suspect to compare
     */equals(a){let l=!1;return a instanceof Z&&(l=this.value===a.value),l}toString(){return this.value}}class U extends q{constructor(a="Country Error"){super(a)}}class R extends x{constructor(a="Street Address Error"){super(a)}}class H extends R{constructor(a="Invalid Locality"){super(a)}}class J extends R{constructor(a="Invalid Postal Code"){super(a)}}class V extends R{constructor(a="Invalid Region"){super(a)}}class W extends R{constructor(a="Invalid Street"){super(a)}}
/**
 * TimezoneException
 *
 * TimezoneException represents a generic timezone error.
 */class $ extends q{constructor(a="Timezone error."){super(a)}}
/**
 * Timezone
 *
 * Timezone represents a Timezone
 */class Y{_id;_offset;_abbreviation;constructor(a,l,n){this._id=a,this._abbreviation=l,this._offset=n}
/**
     * FromId()
     *
...
/**
     ...
     */get utcOffset(){return this._offset}toString(){return this.id}}
/**
 * Coordinates
 *
 * Coordinates represents a geographic longitude/latitude pair.
 */class Q{_long;_lat;constructor(a,l){this._long=a,this._lat=l}
/**
     * equals()
     *
     * equals() compares the suspect to the instance, to determine if they are equals.
     * @param suspect The suspect to compare.
     */equals(a){let l=!1;if(a instanceof Q){const n=a;l=this.longitude===n.longitude&&this.latitude===n.latitude}return l}
/**
     * latitude()
     *
     * gets the latitude.
...
/**
     ...
     *
     * gets teh longitude.
     */get longitude(){return this._long}toString(){return`${this.latitude}, ${this.longitude}`}}
/**
 * Country
 *
...
/**
     ...
     */
constructor(a){const l=a.toUpperCase(),n=s.getName(l,"en");if(!n)
// invalid country
throw new U;this._code=l,this._name=n}
/**
     * code
     *
...
/**
     ...
     * @param suspect The suspect to be compared.
     */equals(a){let l=!1;if(a instanceof X){const n=a;l=this.code===n.code}return l}toString(){return this.name}}
/**
 * Street
 *
 * Street represents an address street.
 */class aa{_line1;_line2;
/**
     ...
     */
constructor(a,l=""){if(!a){throw new W}this._line1=a,this._line2=l}
/**
     * Determines if two streets are equal.
     * @param suspect The value being compared.
     */equals(a){let l=!1;if(a instanceof aa){const n=a;l=this.line1===n.line1&&this.line2==this.line2}return l}
/**
     * line1
     *
...
/**
     ...
     */get line2(){return this._line2}serialize(){return JSON.stringify({line_1:this.line1,line2:this.line2})}toString(){return this.serialize()}}
/**
 * Locality
 *
...
/**
     ...
     */
constructor(a){if(!a){throw new H}this._name=a}
/**
     * Compares the instance to the suspect to determine if they are equal.
     * @param suspect The suspect to compare.
     */equals(a){let l=!1;if(a instanceof la){const n=a;l=this.name===n.name}return l}
/**
     * name
     *
     * gets the locality name.
     */get name(){return this._name}serialize(){return this.name}toString(){return this.serialize()}}
/**
 * Region
 *
...
/**
     ...
     */
constructor(a){if(!a){throw new V}this._name=a}
/**
     * equals()
     *
     * equals() compares the suspect and the instance to determine if they are equal.
     * @param suspect the suspect to be compared.
     */equals(a){let l=!1;if(a instanceof na){const n=a;l=this.name===n.name}return l}
/**
     * name()
     *
...
/**
     ...
     */
constructor(a){if(!a){throw new J}this._value=a}
/**
     * equals()
     *
     * equals() compares the PostalCode object to the suspect to determine if they are equal.
     * @param suspect The value being compared.
     */equals(a){let l=!1;if(a instanceof ha){const n=a;l=this.value===n.value}return l}serialize(){return this.value}toString(){return this.serialize()}
/**
     * value
     *
 ...
 */class ea{_street;_locality;_region;_postal;_country;
/**
     ...
     *
     */
constructor(a,l,n,h,e){let t=null;if(!a)throw t=new W,t;if(!l)throw t=new H,t;if(!n)throw t=new V,t;if(!h)throw t=new J,t;if(!e)throw t=new U,t;this._street=a,this._locality=l,this._region=n,this._postal=h,this._country=e}
/**
     * FromPrimitives()
     *
     ...
     */static FromPrimitives(a,l="",n,h,e,t){const i=new aa(a,l),s=new la(n),r=new na(h),u=new ha(e),p=new X(t);return new ea(i,s,r,u,p)}
/**
     * country
     *
...
/**
     ...
     */equals(a){let l=!1;if(a instanceof ea){const n=a;l=this.street.equals(n.street)&&this.locality.equals(n.locality)&&this.region.equals(n.region)&&this.postalCode.equals(n.postalCode)&&this.country.equals(n.country)}return l}
/**
     * locality
     *
...
/**
     ...
     */get postalCode(){return this._postal}
/**
    * region
    *
    * gets the address region.
    */get region(){return this._region}serialize(){return JSON.stringify({street:this.street.serialize(),locality:this.locality.serialize(),region:this.region.serialize(),postal_code:this.postalCode.serialize(),country:this.country.toString()})}
/**
     * street
     *
     * gets the address street.
     */get street(){return this._street}toString(){return this.serialize()}}
/**
 * DateException
 *
 * DateException represents a generic date error.
 */class ta extends q{constructor(a="Date error."){super(a)}}
/**
 * DurationException
 *
 * DurationException represents a generic duration error.
 */class ia extends q{constructor(a="Duration error."){super(a)}}
/**
 * DateTime
 *
...
/**
     ...
     * @param value Date
     */
constructor(a,l,n,h=0,e=0,i=0,s=0,r=Y.UTC()){if(this.date=t.fromObject({year:a,month:l,day:n,hour:h,minute:e,second:i,millisecond:s},{zone:"utc"}),!this.date.isValid)throw new ta;this.tz=r}
/**
     * FromDate()
     *
     ...
     */static FromDate(a,l){const n=t.fromJSDate(a).toUTC();return new sa(n.year,n.month,n.day,n.hour,n.minute,n.second,n.millisecond,l)}
/**
     * FromIsoString()
     *
     ...
     */static FromIsoString(a,l){const n=t.fromISO(a);return new sa(n.year,n.month,n.day,n.hour,n.minute,n.second,n.millisecond,l)}
/**
     * Local()
     *
     ...
     */static Local(){return sa.FromDate(t.local().toJSDate(),Y.Local())}
/**
     * Now()
     *
     * Creates a DateTime for the current UTC date and time.
     */static Now(a=Y.UTC()){return sa.FromDate(t.utc().toJSDate(),a)}
/**
     * add()
     *
     * add() adds the duration to the datetime.
     * @param duration the duration to add.
     */add(a){return sa.FromDate(this.date.plus(i.fromObject({years:a.years,quarters:a.quarters,months:a.months,weeks:a.weeks,days:a.days,hours:a.hours,minutes:a.minutes,seconds:a.seconds,milliseconds:a.miliseconds})).toJSDate(),this.timezone)}
/**
     * day
     *
...
/**
     ...
     */get hour(){return this.date.hour}
/**
     * isAfter()
     *
     * isAfter() compares the Created instance to the suspect, to determine if the suspect is after the instance.
     * @param suspect The suspect to be compared.
     */isAfter(a){let l=!1;if(a instanceof sa){const n=a;l=this.date>n.date}return l}
/**
     * isBefore()
     *
     ...
     */isBefore(a){let l=!1;if(a instanceof sa){const n=a;l=this.date<n.date}return l}
/**
     * equals()
     *
     ...
     */equals(a){let l=!1;if(a instanceof sa){const n=a;l=this.date.equals(n.date)}return l}
/**
     * milisecond
     *
     * gets the milisecond (0-999)
     */get milisecond(){return this.date.millisecond}
/**
     * minute
     *
     * gets the minute.
     * @note minutes are zero-based (0-59)
     */get minute(){return this.date.minute}
/**
     * month
     *
...
/**
     ...
     */get second(){return this.date.second}
/**
     * subtract()
     *
     * subtract() subtracts a duration form the date time.
     * @param duration the duratin to subtract.
     */subtract(a){return sa.FromDate(this.date.minus(i.fromObject({years:a.years,quarters:a.quarters,months:a.months,weeks:a.weeks,days:a.days,hours:a.hours,minutes:a.minutes,seconds:a.seconds,milliseconds:a.miliseconds})).toJSDate(),this.timezone)}
/**
     * timezone()
     *
     * gets the timestamp timezone.
     */get timezone(){return this.tz}toString(){return this.isoString()}
/**
     * toUtc()
     *
     * toUtc() converts the timestamp to UTC time.
     */toUtc(){return sa.FromDate(this.value,Y.UTC())}
/**
     * toTimeaone()
     *
     * toTimezone() converts the timestamp to the specified timezone.
     * @param timezone The timezone to convert to.
     */toTimezone(a){return sa.FromDate(this.value,a)}
/**
     * isoString()
     *
...
/**
     ...
     */get value(){return this.date.setZone(this.timezone.id).toJSDate()}
/**
     * year
     *
 ...
 */class ra{luxonDuration;
/**
     * creates a Duration object.
     * @param an object specifying information about the Duration.
     * @throws DurationException when the Duration is invalid.
     */
constructor({years:a=0,quarters:l=0,months:n=0,weeks:h=0,days:e=0,hours:t=0,minutes:s=0,seconds:r=0,miliseconds:u=0}){if(this.luxonDuration=i.fromObject({years:a,quarters:l,months:n,weeks:h,days:e,hours:t,minutes:s,seconds:r,milliseconds:u},{conversionAccuracy:"longterm"}),!this.luxonDuration.isValid)
// not valid.
throw new ia(this.luxonDuration.invalidReason)}
/**
     ...
     */static FromDateTimeDifference(a,l){const n=t.fromISO(a.toString()),h=t.fromISO(l.toString()),e=a.isAfter(l)?n.diff(h):h.diff(n);return new ra({years:e.years,quarters:e.quarters,months:e.months,weeks:e.weeks,days:e.days,hours:e.hours,minutes:e.minutes,seconds:e.seconds,miliseconds:e.milliseconds})}
/**
     * days
     *
     * gets the number of days in the duration.
     */get days(){return this.luxonDuration.days}
/**
     * equals()
     *
     * equals() compares the instance to the suspect, to determine if they are equal.
     * @param suspect the suspect to compare.
     */equals(a){let l=!1;if(a instanceof ra){const n=a;l=this.luxonDuration.equals(n.luxonDuration)}return l}
/**
     * hours
     *
     * gets the number of hours in the duration.
     */get hours(){return this.luxonDuration.hours}
/**
     * inDays()
     *
...
/**
     ...
     */get miliseconds(){return this.luxonDuration.milliseconds}
/**
     * minutes
     *
     * gets the minutes of the duration.
     */get minutes(){return this.luxonDuration.minutes}
/**
     * months
     *
     * gets the months of the duration.
     */get months(){return this.luxonDuration.months}
/**
     * quarters
     *
     * gets the quarters in the duration.
     */get quarters(){return this.luxonDuration.quarters}
/**
     * seconds
     *
     * gets the seconds of the duration.
     */get seconds(){return this.luxonDuration.seconds}
/**
     * weeks
     *
     * gets the weeks.
     */get weeks(){return this.luxonDuration.weeks}
/**
     * years
     *
     * gets the years in the duration.
     */get years(){return this.luxonDuration.years}
// ==========================
// Overrides
// ==========================
toString(){return this.luxonDuration.toISO()}}class ua extends x{constructor(a="Invalid Email Address"){super(a)}}
/**
 * EmailAddress
 *
 * EmailAddress provides functionality for handling email addresses.
 */class pa{_value;_domain;_username;
/**
...
// email is invalid.
throw new ua;{this._value=a;const l=a.indexOf("@");this._username=a.substring(0,l),this._domain=a.substring(l+1)}}
/**
     * domainName
     *
     * gets the domain of the email address.
     */get domainName(){return this._domain}
/**
     * equals()
     *
     * equals() compares the instance to the suspect, to determine if they are equal.
     * @param suspect The suspect to be compared.
     */equals(a){let l=!1;if(a instanceof pa){const n=a;l=this.value===n.value}return l}
/**
     * username
     *
     * gets the username of the email address.
     */get username(){return this._username}toString(){return this.value}
/**
     * value
     *
 ...
 */class ca extends oa{constructor(){super()}
/**
     * camelCase()
     *
...
/**
     ...
     */pascalCase(a){return m(this.castToString(a))}
/**
     * pathCase()
     *
     ...
     */pathCase(a){return F(this.castToString(a))}
/**
     * snakeCase()
     *
     ...
     */snakeCase(a){return E(this.castToString(a))}
// =============================
// Helpers
// =============================
/**
 ...
 */class ga extends x{constructor(a="Invalid ID"){super(a)}}
/**
 * UUIDException
 *
 * Indicates an error with the UUID.
 */class ba extends ga{constructor(a="UUID Error"){super(a)}}
/**
 * Id
 *
...
/**
     ...
     */
constructor(a){if(!a)throw new ga;this._val=a}
/**
     * equals()
     *
     * equals() compares the suspect to the intance, to determine if they are equal.
     * @param suspect The suspect to compare.
     */equals(a){let l=!1;if(a instanceof ma){const n=a;l=this.value===n.value}return l}
/**
     * value
     *
     * gets the value of the ID.
     */get value(){return this._val}toString(){return this.value.toString()}}
/**
 * UUID
 *
...
/**
     ...
     */
constructor(a){if(!d(a))throw new ba;super(a)}
/**
     * _ParseNamespace()
     *
     ...
     */static _ParseNamespace(a){let l="";if(a instanceof Fa)l=a.value;else
// we validate that the string is a valid UUID.
try{l=new Fa(a.toString()).toString()}catch(a){
// the namespace is not a valid UUID.
throw new ba("Invalid namespace.")}return l}
/**
     * NIL()
     *
     * Creates the NIL UUID.
     * @returns a nil UUID (all zeros)
     */static NIL(){return new Fa(k)}
/**
     * V1()
     *
     * Generates a Version 1 UUID (Timestamp).
     * @returns A version 1 UUID.
     */static V1(){return new Fa(y())}
/**
     * V3()
     *
     ...
     * @throws UUIDException when the namespace is not a valid UUID.
     */static V3(a,l){return new Fa(f(a,Fa._ParseNamespace(l)))}
/**
     * V4()
     *
     * V4() generates a V4 UUID (random)
     * @returns a Version 4 UUID.
     */static V4(){return new Fa(w())}
/**
     * V5()
     *
     ...
     * @throws UUIDException when the namespace is not a valid UUID.
     */static V5(a,l){return new Fa(v(a,Fa._ParseNamespace(l)))}
/**
     * equals()
     *
     * equals() compares the suspect to the instance, to determine if they are equal.
     * @param suspect The suspect to be compared.
     */equals(a){let l=!1;if(a instanceof Fa){const n=a;l=this.value===n.value}return l}
/**
     * value
     *
     * gets the value of the id.
...
/**
     ...
     */get alpha3b(){return this._alpha3b}
/**
     * alpha3t()
     *
     * gets the alpha3t value.
     */get alpha3t(){return this._alpha3t}
/**
     * equals()
     *
     * compares the instance to the subject to determine if they are equal.
     * @param suspect the suspect to compare.
     */equals(a){let l=!1;if(a instanceof ka){const n=a;l=this.name===n.name&&this.alpha2===n.alpha2&&this.alpha3b===n.alpha3b&&this.alpha3t===n.alpha3t}return l}
/**
     * name
     *
     * gets the language name.
     */get name(){return this._name}toString(){return this.name}}
/**
 * PhoneNumberException
 *
 * Indicates an error with a Phone Number.
 */class ya extends x{constructor(a="Phone Number Error"){super(a)}}
/**
 * PhoneNumber
 *
 * PhoneNumber represents a phone number.
 */class fa{_phoneParser;
/**
...
if(this._phoneParser=_(a,{regionCode:l}),!this._phoneParser.valid)throw new ya}
/**
     ...
     */get canBeInternationallyDialed(){return this._phoneParser.canBeInternationallyDialled}
/**
     * countryCode
     *
...
/**
     ...
     */get e164(){return this._phoneParser.number.e164}
/**
     * international
     *
     * gets the international number.
     */get international(){return this._phoneParser.number.international}
/**
     * isMobile
     *
     * determines if a phone number is mobile.
     */get isMobile(){return this._phoneParser.typeIsMobile}
/**
     * national
     *
     * gets the national phone number.
     */get national(){return this._phoneParser.number.national}
/**
     * rfc3966
     *
     * gets the rfc3966 number.
     */get rfc3966(){return this._phoneParser.number.rfc3966}
/**
     * regionCode
     *
     * gets the phone number's region code.
     */get regionCode(){return this._phoneParser.regionCode}
/**
     * significant
     *
     * gets the significant number of the phone number.
     */get significant(){return this._phoneParser.number.significant}
/**
     * value
     *
     * gets the phone number, in international format.
     */get value(){return this.international}toString(){return this.value}}class wa{constructor(){
...
/**
     ...
     */sanitize(a){return z(a)}toString(){return`Instance of ${wa.name}`}}
/**
 * Currency
 *
 * A representation of currency.
 */class va{symbol;name;decimalPlaces;abreviation;constructor(a,l,n,h=2){this.symbol=a,this.name=l,this.decimalPlaces=h,this.abreviation=n}
/**
     * USD()
     */static USD(){return new va("$","United States Dollar","USD",2)}equals(a){let l=!1;if(a instanceof va){const n=a;l=this.decimalPlaces===n.decimalPlaces&&this.symbol===n.symbol&&this.name===n.name&&this.abreviation===n.abreviation}return l}serialize(){return JSON.stringify({symbol:this.symbol,name:this.name,abreviation:this.abreviation,decimal_places:this.decimalPlaces})}toString(){return this.name}}
/**
 * MoneyException
 *
 * Money error.
 */class Sa extends q{constructor(a="Money Error"){super(a)}}
/**
 * Money
 *
 * A class representing monetary values.
 */class _a{_amountInCents;_currency;constructor(a,l=va.USD()){this._amountInCents=this._toInteger(a,l.decimalPlaces),this._currency=l}get amount(){return this._toDecimal(this.amountInCents,this.currency.decimalPlaces)}get amountInCents(){return this._amountInCents}get currency(){return this._currency}
/**
     * add()
     *
     ...
     */add(a){if(this.currency.symbol!==a.currency.symbol)throw new Sa(`Cannot add money with different currencies (${this.currency.symbol} and ${a.currency.symbol})`);const l=this._toDecimal(this.amountInCents+a.amountInCents,this.currency.decimalPlaces);return new _a(l,this.currency)}
/**
     * divide()
     *
     * divides the money value by the factor.
     * @param divisor the divisor
     */divide(a){if(0!==a){const l=this._toDecimal(this.amountInCents/a,this.currency.decimalPlaces);return new _a(l,this.currency)}throw new Sa("Cannot divide by zero.")}equals(a){let l=!1;if(a instanceof _a){const n=a;l=this.currency.equals(n.currency)&&this.amountInCents===n.amountInCents}return l}
/**
     * multiply()
     *
     * multiplies the money value by the factor.
     * @param factor the factor
     */multiply(a){const l=this._toDecimal(this.amountInCents*a,this.currency.decimalPlaces);return new _a(l,this.currency)}serialize(){return JSON.stringify({amount:this.amount,amount_in_cents:this.amountInCents,currency:this.currency.serialize()})}
/**
     * subtract()
     *
     ...
     */subtract(a){if(this.currency.symbol!==a.currency.symbol)throw new Sa(`Cannot subtract money with different currencies (${this.currency.symbol} and ${a.currency.symbol})`);const l=this._toDecimal(this.amountInCents-a.amountInCents,this.currency.decimalPlaces);return new _a(l,this.currency)}
/**
     * _toDecimal()
     *
...
/**
     ...
     */_toInteger(a,l=2){return Math.round(a*Math.pow(10,l))}toString(){return`${this.currency.symbol}${this.amount} ${this.currency.name}`}}export{q as BaseException,oa as BaseFormatter,C as CharacterSet,O as Color,T as ColorException,j as ComparisonResult,Q as Coordinates,X as Country,U as CountryException,va as Currency,ta as DateException,sa as DateTime,ra as Duration,ia as DurationException,pa as EmailAddress,ua as EmailAddressException,wa as HTMLSanitizer,Z as Hash,P as Hex,B as HexException,ma as Id,ga as IdException,x as InvalidArgumentException,ka as IsoLanguage,Ea as IsoLanguageException,la as Locality,H as LocalityException,A as MethodUndefinedException,_a as Money,Sa as MoneyException,M as NetworkException,D as OutOfBoundsException,fa as PhoneNumber,ya as PhoneNumberException,ha as PostalCode,J as PostalCodeException,K as RGBA,L as RGBAException,N as Random,na as Region,V as RegionException,G as Salt,aa as Street,ea as StreetAddress,R as StreetAddressException,W as StreetException,ca as StringFormatter,Y as Timezone,$ as TimezoneException,Fa as UUID,ba as UUIDException,I as compare};
