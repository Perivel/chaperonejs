 ...
 */var N;!function(a){a[a.Less=0]="Less",a[a.Same=1]="Same",a[a.Greater=2]="Greater"}(N||(N={}));
/**
 * ColorException
 *
 ...
 *
 * A Hex value error.
 */class M extends T{constructor(a="Hex Error"){super(a)}}
/**
 * Hex
 *
 * A Hex color value.
...
/**
     ...
     */
constructor(l){if(l=l.toUpperCase(),!a(l))throw new M;this._value=l}equals(a){let l=!1;if(a instanceof B){const n=a;l=this.value===n.value}return l}serialize(){return this.value}toString(){return this.serialize()}
/**
     * value()
     *
     * gets the value.
 ...
 *
 * An RGBA value error.
 */class I extends T{constructor(a="RGBA Error"){super(a)}}
/**
 * RGBA
 *
...
/**
     ...
     */static Black(a=1){return K.FromRGBA(0,0,0,a)}
/**
     * Blue()
     *
     ...
     */static Blue(a=1){return K.FromRGBA(0,0,255,a)}
/**
     * FromHex()
     *
     ...
     * @throws HexException when the Hex value is invalid.
     */static FromHex(a){const l=new B(a);return new K(l)}
/**
     * FromRGBA()
     *
...
/**
     ...
     */static Green(a=1){return K.FromRGBA(0,255,0,a)}
/**
     * Red()
     *
     ...
     */static Red(a=1){return K.FromRGBA(255,0,0,a)}
/**
     * White()
     *
     ...
     */static White(a=1){return K.FromRGBA(255,255,255,a)}equals(a){let l=!1;if(a instanceof K){const n=a;l=this.rgba.equals(n.rgba)&&this.hex.equals(n.hex)}return l}
/**
     * hex()
     *
...
/**
     ...
     */static async Generate(a=10){return new P(await h.genSalt(a))}
/**
     * equals()
     *
     ...
     */equals(a){let l=!1;return a instanceof P&&(l=a.value===this.value),l}
/**
     * value
     *
...
return new Promise(((n,e)=>{h.hash(a.toString(),l.value,((a,l)=>{a?e(a):n(new O(l))}))}))}
/**
      * value
      *
...
/**
     ...
     * @param suspect the suspect to compare
     */equals(a){let l=!1;return a instanceof O&&(l=this.value===a.value),l}toString(){return this.value}}class G extends C{constructor(a="Country Error"){super(a)}}class Z extends x{constructor(a="Street Address Error"){super(a)}}class U extends Z{constructor(a="Invalid Locality"){super(a)}}class R extends Z{constructor(a="Invalid Postal Code"){super(a)}}class H extends Z{constructor(a="Invalid Region"){super(a)}}class J extends Z{constructor(a="Invalid Street"){super(a)}}
/**
 * TimezoneException
 *
 * TimezoneException represents a generic timezone error.
 */class V extends C{constructor(a="Timezone error."){super(a)}}
/**
 * Timezone
 *
 * Timezone represents a Timezone
 */class W{constructor(a,l,n){this._id=a,this._abbreviation=l,this._offset=n}
/**
     * FromId()
     *
...
throw new V;
// timezone exists.
const l=e.create(a),n=i.fromJSDate(new Date).setZone(l);return new W(l.name,n.toFormat("ZZZZ"),n.offset)}
/**
     * Local()
     *
     ...
     */static Local(){const a=i.local();return new W(a.zone.name,a.toFormat("ZZZZ"),a.offset)}
/**
     * UTC()
     *
     * UTC() sets the timezone to UTC.
     */static UTC(){const a=i.fromJSDate(new Date).setZone("utc");return new W(a.zone.name,a.toFormat("ZZZZ"),a.offset)}
/**
     * abbreviation
     *
...
/**
     ...
     */equals(a){let l=!1;if(a instanceof W){const n=a;l=this.id===n.id&&this.abbreviation===n.abbreviation&&this.utcOffset===n.utcOffset}return l}
/**
     * id
     *
...
// invalid country
throw new G;this._code=l,this._name=n}
/**
     * code
     *
...
/**
     ...
     * @param suspect The suspect to be compared.
     */equals(a){let l=!1;if(a instanceof $){const n=a;l=this.code===n.code}return l}toString(){return this.name}}
/**
 * Street
 *
...
/**
     ...
     */
constructor(a,l=""){if(!a){throw new J}this._line1=a,this._line2=l}
/**
     * Determines if two streets are equal.
     * @param suspect The value being compared.
     */equals(a){let l=!1;if(a instanceof Q){const n=a;l=this.line1===n.line1&&this.line2==this.line2}return l}
/**
     * line1
     *
...
/**
     ...
     */
constructor(a){if(!a){throw new U}this._name=a}
/**
     * Compares the instance to the suspect to determine if they are equal.
     * @param suspect The suspect to compare.
...
/**
     ...
     */
constructor(a){if(!a){throw new R}this._value=a}
/**
     * equals()
     *
     * equals() compares the PostalCode object to the suspect to determine if they are equal.
     * @param suspect The value being compared.
     */equals(a){let l=!1;if(a instanceof la){const n=a;l=this.value===n.value}return l}serialize(){return this.value}toString(){return this.serialize()}
/**
     * value
     *
...
/**
     ...
     *
     */
constructor(a,l,n,h,e){let i=null;if(!a)throw i=new J,i;if(!l)throw i=new U,i;if(!n)throw i=new H,i;if(!h)throw i=new R,i;if(!e)throw i=new G,i;this._street=a,this._locality=l,this._region=n,this._postal=h,this._country=e}
/**
     * FromPrimitives()
     *
     ...
     */static FromPrimitives(a,l="",n,h,e,i){const s=new Q(a,l),t=new X(n),r=new aa(h),u=new la(e),p=new $(i);return new na(s,t,r,u,p)}
/**
     * country
     *
...
/**
     ...
     */equals(a){let l=!1;if(a instanceof na){const n=a;l=this.street.equals(n.street)&&this.locality.equals(n.locality)&&this.region.equals(n.region)&&this.postalCode.equals(n.postalCode)&&this.country.equals(n.country)}return l}
/**
     * locality
     *
 ...
 */class ha extends C{constructor(a="Date error."){super(a)}}
/**
 * DurationException
 *
 * DurationException represents a generic duration error.
 */class ea extends C{constructor(a="Duration error."){super(a)}}
/**
 * DateTime
 *
...
/**
     ...
     * @param value Date
     */
constructor(a,l,n,h=0,e=0,s=0,t=0,r=W.UTC()){if(this.date=i.fromObject({year:a,month:l,day:n,hour:h,minute:e,second:s,millisecond:t},{zone:"utc"}),!this.date.isValid)throw new ha;this.tz=r}
/**
     * FromDate()
     *
     ...
     */static FromDate(a,l){const n=i.fromJSDate(a).toUTC();return new ia(n.year,n.month,n.day,n.hour,n.minute,n.second,n.millisecond,l)}
/**
     * FromIsoString()
     *
     ...
     */static FromIsoString(a,l){const n=i.fromISO(a);return new ia(n.year,n.month,n.day,n.hour,n.minute,n.second,n.millisecond,l)}
/**
     * Local()
     *
     ...
     */static Local(){return ia.FromDate(i.local().toJSDate(),W.Local())}
/**
     * Now()
     *
     * Creates a DateTime for the current UTC date and time.
     */static Now(a=W.UTC()){return ia.FromDate(i.utc().toJSDate(),a)}
/**
     * add()
     *
     * add() adds the duration to the datetime.
     * @param duration the duration to add.
     */add(a){return ia.FromDate(this.date.plus(s.fromObject({years:a.years,quarters:a.quarters,months:a.months,weeks:a.weeks,days:a.days,hours:a.hours,minutes:a.minutes,seconds:a.seconds,milliseconds:a.miliseconds})).toJSDate(),this.timezone)}
/**
     * day
     *
...
/**
     ...
     * @param suspect The suspect to be compared.
     */isAfter(a){let l=!1;if(a instanceof ia){const n=a;l=this.date>n.date}return l}
/**
     * isBefore()
     *
     ...
     */isBefore(a){let l=!1;if(a instanceof ia){const n=a;l=this.date<n.date}return l}
/**
     * equals()
     *
     ...
     */equals(a){let l=!1;if(a instanceof ia){const n=a;l=this.date.equals(n.date)}return l}
/**
     * milisecond
     *
...
/**
     ...
     */subtract(a){return ia.FromDate(this.date.minus(s.fromObject({years:a.years,quarters:a.quarters,months:a.months,weeks:a.weeks,days:a.days,hours:a.hours,minutes:a.minutes,seconds:a.seconds,milliseconds:a.miliseconds})).toJSDate(),this.timezone)}
/**
     * timezone()
     *
...
/**
     ...
     */toUtc(){return ia.FromDate(this.value,W.UTC())}
/**
     * toTimeaone()
     *
     * toTimezone() converts the timestamp to the specified timezone.
     * @param timezone The timezone to convert to.
     */toTimezone(a){return ia.FromDate(this.value,a)}
/**
     * isoString()
     *
...
// not valid.
throw new ea(this.luxonDuration.invalidReason)}
/**
...
// Overrides
// ==========================
toString(){return this.luxonDuration.toISO()}}class ta extends x{constructor(a="Invalid Email Address"){super(a)}}
/**
 * EmailAddress
 *
...
// email is invalid.
throw new ta;{this._value=a;const l=a.indexOf("@");this._username=a.substring(0,l),this._domain=a.substring(l+1)}}
/**
     * domainName
     *
...
/**
     ...
     * equals() compares the instance to the suspect, to determine if they are equal.
     * @param suspect The suspect to be compared.
     */equals(a){let l=!1;if(a instanceof ra){const n=a;l=this.value===n.value}return l}
/**
     * username
     *
 ...
 */class ua{constructor(){}}
/**
 * StringFormatter
 *
 * A utility class to format strings.
 */class pa extends ua{constructor(){super()}
/**
     * camelCase()
     *
 ...
 */class oa extends x{constructor(a="Invalid ID"){super(a)}}
/**
 * UUIDException
 *
 * Indicates an error with the UUID.
 */class ga extends oa{constructor(a="UUID Error"){super(a)}}
/**
 * Id
 *
...
/**
     ...
     */
constructor(a){if(!a)throw new oa;this._val=a}
/**
     * equals()
     *
     * equals() compares the suspect to the intance, to determine if they are equal.
     * @param suspect The suspect to compare.
     */equals(a){let l=!1;if(a instanceof ca){const n=a;l=this.value===n.value}return l}
/**
     * value
     *
...
/**
     ...
     */
constructor(a){if(!d(a))throw new ga;super(a)}
/**
     * _ParseNamespace()
     *
     ...
     */static _ParseNamespace(a){let l="";if(a instanceof ba)l=a.value;else
// we validate that the string is a valid UUID.
try{l=new ba(a.toString()).toString()}catch(a){
// the namespace is not a valid UUID.
throw new ga("Invalid namespace.")}return l}
/**
     * NIL()
     *
     * Creates the NIL UUID.
     * @returns a nil UUID (all zeros)
     */static NIL(){return new ba(k)}
/**
     * V1()
     *
     * Generates a Version 1 UUID (Timestamp).
     * @returns A version 1 UUID.
     */static V1(){return new ba(w())}
/**
     * V3()
     *
     ...
     * @throws UUIDException when the namespace is not a valid UUID.
     */static V3(a,l){return new ba(f(a,ba._ParseNamespace(l)))}
/**
     * V4()
     *
     * V4() generates a V4 UUID (random)
     * @returns a Version 4 UUID.
     */static V4(){return new ba(y())}
/**
     * V5()
     *
     ...
     * @throws UUIDException when the namespace is not a valid UUID.
     */static V5(a,l){return new ba(v(a,ba._ParseNamespace(l)))}
/**
     * equals()
     *
...
/**
     ...
     * @param suspect the suspect to compare.
     */equals(a){let l=!1;if(a instanceof ma){const n=a;l=this.name===n.name&&this.alpha2===n.alpha2&&this.alpha3b===n.alpha3b&&this.alpha3t===n.alpha3t}return l}
/**
     * name
     *
 ...
 */class da extends x{constructor(a="Phone Number Error"){super(a)}}
/**
 * PhoneNumber
 *
...
if(this._phoneParser=z(a,{regionCode:l}),!this._phoneParser.valid)throw new da}
/**
...
/**
     ...
     */equals(a){let l=!1;if(a instanceof ka){const n=a;l=this.value===n.value}return l}
/**
     * e164
     *
...
/**
     ...
     */sanitize(a){return _(a)}toString(){return`Instance of ${wa.name}`}}export{C as BaseException,ua as BaseFormatter,q as CharacterSet,K as Color,T as ColorException,N as ComparisonResult,Y as Coordinates,$ as Country,G as CountryException,ha as DateException,ia as DateTime,sa as Duration,ea as DurationException,ra as EmailAddress,ta as EmailAddressException,wa as HTMLSanitizer,O as Hash,B as Hex,M as HexException,ca as Id,oa as IdException,x as InvalidArgumentException,ma as IsoLanguage,Fa as IsoLanguageException,X as Locality,U as LocalityException,A as MethodUndefinedException,j as NetworkException,D as OutOfBoundsException,ka as PhoneNumber,da as PhoneNumberException,la as PostalCode,R as PostalCodeException,L as RGBA,I as RGBAException,aa as Region,H as RegionException,P as Salt,Q as Street,na as StreetAddress,Z as StreetAddressException,J as StreetException,pa as StringFormatter,W as Timezone,V as TimezoneException,ba as UUID,ga as UUIDException};
